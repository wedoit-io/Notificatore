          ...
          if (!this.RowSel[i])
          {
            ...
            if (RD3_ServerParams.CompletePanelBorders)
            {
              ...
              if (this.ShowMultipleSel && !RD3_Glb.IsIE(10, false))
                rs.style.margin = (RD3_ServerParams.Theme == "zen" ? "7px 8px" : "1px");
              //
...
{ 
  ...
  if (this.ScrollBox)
  {
    ...
    this.ScrollBox.style.top = (ft + (panHasBrd ? 1 : 0)) + ((RD3_ServerParams.CompletePanelBorders && RD3_ServerParams.Theme != "zen") ? -1 : 0) + "px";
  ...
  if (this.RowSel)
  {
    ...
    var rst = ft;
    if (RD3_ServerParams.Theme == "zen" && !RD3_ServerParams.CompletePanelBorders) {
      rst += 3;
      if (this.ShowMultipleSel) {
        rsd += 5;
        rst += 5;
  ...
  if (this.ToggleMultiSelCmd)
  {
    if (RD3_ServerParams.CompletePanelBorders)
    {
      ...
      this.ToggleMultiSelCmd.style.paddingLeft = (RD3_ServerParams.Theme == "zen" ? 0 : rc.pxl) + "px";
    }
    else
    {
      this.ToggleMultiSelCmd.style.left = (this.ListLeft + (RD3_ServerParams.Theme == "zen" ? 9 : 5)) + "px";
  ...
  if (this.MultiSelectAllCmd)
  {
    this.MultiSelectAllCmd.style.left = (this.ListLeft + (RD3_ServerParams.Theme == "zen" ? 9 : 5)) + "px";
    this.MultiSelectAllCmd.style.top = (this.ListTop + (RD3_Glb.IsTouch()?14:(RD3_ServerParams.Theme == "zen"?13:11))) + "px";
  ...
  if (this.MultiSelectNoneCmd)
  {
    this.MultiSelectNoneCmd.style.left = (this.ListLeft + (RD3_ServerParams.Theme == "zen" ? 9 : 5)) + "px";
    this.MultiSelectNoneCmd.style.top = (this.ListTop + (RD3_Glb.IsTouch()?28:(RD3_ServerParams.Theme == "zen"?26:22))) + "px";
...
IDPanel.prototype.UpdateToolbar = function()
{
  ...
  if ((RD3_ServerParams.Theme=="seattle" || RD3_ServerParams.Theme=="zen") && !mob)
  {
