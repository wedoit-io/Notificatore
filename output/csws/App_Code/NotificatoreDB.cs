...
public sealed class NotificatoreDB : IDBObject
{
  ...
  public NotificatoreDB(com.progamma.ws.WebEntryPoint p)
  {
    MainFrm=p;
    DB.Parent = this;
    vDefaultUserId = "IUNIV_MM_PROD";
    vDefaultPassword = "h5j0b5mu!";
    vDefaultConnStr = "Data Source=IUNIV_MM_PROD;Persist Security Info=False";
    DBType = 256;
    DB.Unicode = true;
  ...
  // Messaggio - Input
  // **********************************************************************
  public int WriteMessageLog (IDVariant Messaggio)
  {
