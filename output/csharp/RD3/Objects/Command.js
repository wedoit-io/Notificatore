...
Command.prototype.SetExpanded= function(value) 
{
  ...
  if (this.Realized && this.IsCmdSet && this.IsMenu)
  {
    ...
    if (this.Expanded)	
    {
    	...
    	else
    	{
	      if (this.CommandImg && this.Image=="")
	        this.CommandImg.src = RD3_Glb.GetImgSrc((RD3_ServerParams.Theme == "seattle" || RD3_ServerParams.Theme == "zen") ? "images/openedslev" + this.Level + ".gif" : "images/opened.gif");
	      if (this.CommandImgDX)
	      {
	        this.CommandImgDX.src = RD3_Glb.GetImgSrc((RD3_ServerParams.Theme == "seattle" || RD3_ServerParams.Theme == "zen") ? "images/openedslev" + this.Level + ".gif" : "images/opened.gif");
    ...
    else
    {
    	...
    	{
	      if (this.CommandImg && this.Image=="")
	        this.CommandImg.src = RD3_Glb.GetImgSrc((RD3_ServerParams.Theme == "seattle" || RD3_ServerParams.Theme == "zen") ? "images/closedslev" + this.Level + ".gif" : "images/closed.gif");
	      if (this.CommandImgDX)
	      {
	        this.CommandImgDX.src = RD3_Glb.GetImgSrc((RD3_ServerParams.Theme == "seattle" || RD3_ServerParams.Theme == "zen") ? "images/closedslev" + this.Level + ".gif" : "images/closed.gif");
	        if (!RD3_Glb.IsIE(10, false))
	          this.CommandImgDX.onload = new Function("ev","return RD3_DesktopManager.CallEventHandler('"+this.Identifier+"', 'OnReadyStateChange', ev)");
	      }
	      if (this.MenuBox && (old!=this.Expanded || value==undefined))
