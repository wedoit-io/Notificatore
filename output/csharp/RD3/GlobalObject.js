...
GlobalObject.prototype.IsSafari= function(ver)
{
  ...
  {
    this.uaSafari = navigator.userAgent.indexOf("Safari")>-1 && navigator.userAgent.indexOf("Chrome") < 0;
...
GlobalObject.prototype.IsIphone= function(ver)
{
  ...
  {
    this.uaIphone = navigator.userAgent.indexOf("iPhone")>-1;
...
GlobalObject.prototype.IsAndroid= function(maj, minor, branch)
{
  ...
  {
    this.uaAndroid = navigator.userAgent.indexOf("Android")>-1;
    //
    try
    {
      var androidVer = "";
...
GlobalObject.prototype.isInsideEditor = function(srcobj)
{
  ...
  //
  // Ultimo test..
  if (srcobj && srcobj.ownerDocument.URL == "about:blank")
    return true;
  //
  return false;
}