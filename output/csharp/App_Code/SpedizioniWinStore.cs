...
[Serializable]
public partial class SpedizioniWinStore : MyWebForm
{
  ...
  private const int PFL_SPEDIZIONI_BADGE = 7;
  private const int PFL_SPEDIZIONI_STATO = 8;
  private const int PFL_SPEDIZIONI_NUMEROTENTAT = 9;
  private const int PFL_SPEDIZIONI_DEVICETOKEN = 10;
  private const int PFL_SPEDIZIONI_REGURL = 11;
  private const int PFL_SPEDIZIONI_INFO = 12;
  private const int PFL_SPEDIZIONI_MESSAGGIO = 13;
  private const int PFL_SPEDIZIONI_TYPEOS = 14;

  private const int PPQRY_SPEDIZIONI4 = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    //
    //
    Init_PQRY_SPEDIZIONI4(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_PQRY_SPEDIZIONI4(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_SPEDIZIONI4, 15);
    IMDB.set_TblCode(IMDBDef1.PQRY_SPEDIZIONI4, "PQRY_SPEDIZIONI4");
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_ID, "ID");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_ID,1,9,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DES_MESSAGGIO, "DES_MESSAGGIO");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DES_MESSAGGIO,9,1000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DEV_TOKEN, "DEV_TOKEN");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DEV_TOKEN,5,1000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_FLG_STATO, "FLG_STATO");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_FLG_STATO,5,1,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_ID_APPLICAZIONE, "ID_APPLICAZIONE");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_ID_APPLICAZIONE,1,9,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DAT_CREAZ, "DAT_CREAZ");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DAT_CREAZ,8,61,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DAT_ELAB, "DAT_ELAB");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DAT_ELAB,8,61,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_BADGE, "BADGE");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_BADGE,1,9,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DES_UTENTE, "DES_UTENTE");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DES_UTENTE,5,1000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_REG_ID, "REG_ID");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_REG_ID,5,200,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_TYPE_OS, "TYPE_OS");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_TYPE_OS,5,1,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DISPNOTISPED, "DISPNOTISPED");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_DISPNOTISPED,9,1000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_INFO, "INFO");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_INFO,5,2000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_TENTATIVI, "TENTATIVI");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_TENTATIVI,1,3,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_GUID_GRUPPO, "GUID_GRUPPO");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI4,IMDBDef1.PQSL_SPEDIZIONI4_GUID_GRUPPO,5,200,0);
    IMDB.TblAddNew(IMDBDef1.PQRY_SPEDIZIONI4, 0);
  }
  ...
  // **********************************************
  public SpedizioniWinStore(MyWebEntryPoint w, IMDBObj imdb)
    : base()
  {
    //
    SetMainFrm(w, imdb);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SPEDIWINSTOR;
    //
    if (flMulti)
      MainFrm.AddMultipleForm(this, flSubForm);
    //
    //
    RTCGuid = "BE1C3CDB-28BC-4BF9-A55D-E1095D10D265";
    ResModeW = 3;
    ResModeH = 3;
    iVisualFlags = -2049;
    DesignWidth = 1028;
    DesignHeight = 856;
    set_Caption(new IDVariant("Spedizioni Win Store"));
    //
    Frames = new AFrame[2];
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 1028-MyGlb.PAN_OFFS_X, 796-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "B780712E-DBC3-4357-A4D8-E9C00DE7F608");
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 952, 500, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  {
    if (CmdIdx==MyGlb.CMD_INVIASUBITO2+BaseCmdLinIdx)
    {
      Inviasubito();
      goto fine;
    }
  ...
  {
    return (obj is SpedizioniWinStore);
  }
  ...
  {
    return (FullName ? typeof(SpedizioniWinStore).FullName : typeof(SpedizioniWinStore).Name);
  }
  ...
  private void PAN_SPEDIZIONI_ValidateRow(IDVariant Cancel)
  {
    try
    {
      if (IDL.IsNull(IMDB.Value(IMDBDef1.PQRY_SPEDIZIONI4, IMDBDef1.PQSL_SPEDIZIONI4_DAT_CREAZ, 0)))
      {
        IMDB.set_Value(IMDBDef1.PQRY_SPEDIZIONI4, IMDBDef1.PQSL_SPEDIZIONI4_DAT_CREAZ, 0, IDL.Now());
      }
      if (IDL.IsNull(IMDB.Value(IMDBDef1.PQRY_SPEDIZIONI4, IMDBDef1.PQSL_SPEDIZIONI4_FLG_STATO, 0)))
      {
        IMDB.set_Value(IMDBDef1.PQRY_SPEDIZIONI4, IMDBDef1.PQSL_SPEDIZIONI4_FLG_STATO, 0, (new IDVariant("W")));
      }
      if (IDL.IsNull(IMDB.Value(IMDBDef1.PQRY_SPEDIZIONI4, IMDBDef1.PQSL_SPEDIZIONI4_TYPE_OS, 0)))
      {
        IMDB.set_Value(IMDBDef1.PQRY_SPEDIZIONI4, IMDBDef1.PQSL_SPEDIZIONI4_TYPE_OS, 0, (new IDVariant("1")));
      }
    } catch ( Exception e) { }
  }
  ...
  private void PAN_SPEDIZIONI_Init()
  {
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_ID, "B2AAE409-13F0-4C64-A187-FB287B2C5504");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_APPLICAZIONE, "ADB3AAC2-17CB-4F58-ADA7-E30E2DB53B78");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAINSERIME, "B8B6783A-6818-4D40-B48C-B40B5406C058");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAELABORAZ, "1B3CD484-8A7C-40E2-97A8-1E88C0CA02FC");
    ...
    PAN_SPEDIZIONI.SetFlags(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAELABORAZ, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISOPT, -1);
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_UTENTE, "66998FE6-E2E5-4EF9-B15D-11BF4D795935");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DISPOSITNOTI, "E5C8A4FE-B724-4AA4-A37F-F5695D1F1283");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, "AAFD3753-582B-4A99-83FD-2B8844ED95E4");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, "29E942BD-4445-4FE2-83DF-4420CD1F3971");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, "9B509076-080A-4F17-8309-480ED007BBF0");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, "99845AB5-1986-48C3-82E1-B87623E16C17");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, "68AF4701-8F1A-48F9-9DFB-DDE7A09F78E1");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGURL, "4303AF26-CA22-47BD-A01A-EC8281CE4098");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, "EAED003B-F46A-4056-9661-4618805CACB7");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, "73E4F756-FB89-4756-ABF0-00884622ABAC");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_TYPEOS, "650BD395-9346-45E5-86F4-677F873E2471");
  ...
  private void PAN_SPEDIZIONI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_ID, MyGlb.PANEL_LIST, 0, 32, 56, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_ID, PPQRY_SPEDIZIONI4, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_APPLICAZIONE, MyGlb.PANEL_LIST, 56, 32, 88, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_APPLICAZIONE, PPQRY_SPEDIZIONI4, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAINSERIME, MyGlb.PANEL_LIST, 144, 32, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAINSERIME, PPQRY_SPEDIZIONI4, "A.DAT_CREAZ", "DAT_CREAZ", 8, 61, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAELABORAZ, MyGlb.PANEL_LIST, 252, 32, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAELABORAZ, MyGlb.PANEL_LIST, "Dt. Elaborazione");
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAELABORAZ, PPQRY_SPEDIZIONI4, "A.DAT_ELAB", "DAT_ELAB", 8, 61, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_UTENTE, MyGlb.PANEL_LIST, 360, 32, 152, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_UTENTE, PPQRY_SPEDIZIONI4, "A.DES_UTENTE", "DES_UTENTE", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DISPOSITNOTI, MyGlb.PANEL_LIST, 512, 32, 200, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
  ...
  SQL.Append(")");
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DISPOSITNOTI, PPQRY_SPEDIZIONI4, SQL.ToString(), "DISPNOTISPED", 9, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_LIST, 712, 32, 96, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_LIST, "Gd. Grup. Invio");
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_FORM, "Gd. Grup. Invio");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_GUIDGRUPINVI, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_GUIDGRUPINVI, PPQRY_SPEDIZIONI4, "A.GUID_GRUPPO", "GUID_GRUPPO", 5, 200, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, MyGlb.PANEL_LIST, 808, 32, 32, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_BADGE, PPQRY_SPEDIZIONI4, "A.BADGE", "BADGE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, MyGlb.PANEL_LIST, 840, 32, 80, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_STATO, PPQRY_SPEDIZIONI4, "A.FLG_STATO", "FLG_STATO", 5, 1, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_LIST, 920, 32, 32, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_LIST, "N. T.");
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_FORM, "Num. Tentativi");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_NUMEROTENTAT, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_NUMEROTENTAT, PPQRY_SPEDIZIONI4, "A.TENTATIVI", "TENTATIVI", 1, 3, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, MyGlb.PANEL_LIST, 452, 520, 500, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, MyGlb.PANEL_LIST, "Dev. Token");
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DEVICETOKEN, PPQRY_SPEDIZIONI4, "A.DEV_TOKEN", "DEV_TOKEN", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGURL, MyGlb.PANEL_LIST, 452, 548, 500, 80, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGURL, MyGlb.PANEL_FORM, 1);
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGURL, MyGlb.PANEL_FORM, "R. u.");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_REGURL, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_REGURL, PPQRY_SPEDIZIONI4, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 452, 624, 500, 96, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    PAN_SPEDIZIONI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 20);
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 4);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_INFO, PPQRY_SPEDIZIONI4, "A.INFO", "INFO", 5, 2000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, 0, 516, 436, 204, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    PAN_SPEDIZIONI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, 20);
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, 10);
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, "Messaggio");
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_FORM, 4, 28, 460, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_SPEDIZIONI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_FORM, 60);
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_FORM, 1);
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_FORM, "Mess.");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_MESSAGGIO, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_MESSAGGIO, PPQRY_SPEDIZIONI4, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_TYPEOS, MyGlb.PANEL_LIST, 1028, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_TYPEOS, MyGlb.PANEL_FORM, "Typ. O.");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_TYPEOS, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_TYPEOS, PPQRY_SPEDIZIONI4, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
  ...
  private void PAN_SPEDIZIONI_InitQueries()
  {
    ...
    PAN_SPEDIZIONI.SetQuery(PPQRY_SPEDIZIONI4, 1, SQL, -1, "");
    SQL = new StringBuilder();
    SQL.Append("where (A.TYPE_OS = '5') ");
    PAN_SPEDIZIONI.SetQuery(PPQRY_SPEDIZIONI4, 2, SQL, -1, "");
    SQL = new StringBuilder();
    PAN_SPEDIZIONI.SetQuery(PPQRY_SPEDIZIONI4, 3, SQL, -1, "");
    SQL = new StringBuilder();
