...
public partial class SpedizioniWinStore : MyWebForm
{
  ...
  private void PAN_SPEDIZIONI_InitFields()
  {
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_ID, PPQRY_SPEDIZIONI4, "A.ID", "ID", 1, 9, 0, -685);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_APPLICAZIONE, PPQRY_SPEDIZIONI4, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -685);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAINSERIME, PPQRY_SPEDIZIONI4, "A.DAT_CREAZ", "DAT_CREAZ", 8, 61, 0, -685);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAELABORAZ, PPQRY_SPEDIZIONI4, "A.DAT_ELAB", "DAT_ELAB", 8, 61, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_UTENTE, MyGlb.PANEL_LIST, 560, 36, 152, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_UTENTE, PPQRY_SPEDIZIONI4, "A.DES_UTENTE", "DES_UTENTE", 5, 1000, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DISPOSITNOTI, MyGlb.PANEL_LIST, 360, 36, 200, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
  ...
  SQL.Append(")");
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DISPOSITNOTI, PPQRY_SPEDIZIONI4, SQL.ToString(), "DISPNOTISPED", 9, 1000, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_LIST, 712, 36, 96, 20, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_GUIDGRUPINVI, PPQRY_SPEDIZIONI4, "A.GUID_GRUPPO", "GUID_GRUPPO", 5, 200, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, MyGlb.PANEL_LIST, 808, 36, 32, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_BADGE, PPQRY_SPEDIZIONI4, "A.BADGE", "BADGE", 1, 9, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, MyGlb.PANEL_LIST, 840, 36, 80, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_STATO, PPQRY_SPEDIZIONI4, "A.FLG_STATO", "FLG_STATO", 5, 1, 0, -685);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_LIST, 920, 36, 32, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_NUMEROTENTAT, PPQRY_SPEDIZIONI4, "A.TENTATIVI", "TENTATIVI", 1, 3, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, MyGlb.PANEL_LIST, 452, 520, 500, 20, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DEVICETOKEN, PPQRY_SPEDIZIONI4, "A.DEV_TOKEN", "DEV_TOKEN", 5, 1000, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGURL, MyGlb.PANEL_LIST, 452, 548, 500, 72, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_REGURL, PPQRY_SPEDIZIONI4, "A.REG_ID", "REG_ID", 5, 200, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 452, 624, 500, 88, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_INFO, PPQRY_SPEDIZIONI4, "A.INFO", "INFO", 5, 2000, 0, -685);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, 0, 516, 436, 196, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_MESSAGGIO, PPQRY_SPEDIZIONI4, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -685);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_TYPEOS, PPQRY_SPEDIZIONI4, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -685);
