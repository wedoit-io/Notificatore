...
public sealed class MyWebEntryPoint : WebEntryPoint
{
  ...
  public String DebugButton()
  {
    if (DTTObj.Level > 0 && !DTTObj.TraceEnabled)
    {
      if (String.Compare(ParamsObj().Theme, "zen", true) != 0)
        ...
        return "<a href=\"" + UrlForEnc(MyGlb.ITEM_DTT, "") + "\" target=Debug><img alt=\"Open Debug Window\" src=\"images/bug.gif\" style=\"border:none;\"></a>";
    }
    //
    return "";
  }
        ...
        if (v_TROVATAAPP.booleanValue())
        {
          ...
          try
          {
            ...
            while (!C7.EOF())
            {
              ...
              IDVariant v_SALERT = new IDVariant(0,IDVariant.STRING);
              ...
              {
                v_SALERT = new IDVariant(C7.Get("RMESSAGGIO"));
              }
              // 
              ...
              v_SPAYLOAD = IDL.FormatMessage((new IDVariant("{\n    \"aps\" : {\n        \"alert\" : \"|1\",\n        \"badge\" : |2,\n        \"sound\" : \"|3\"\n    },\n    \"custom-field-1\" : \"|4\",\n    \"custom-field-2\" : \"|5\"\n}")), v_SALERT, v_SBADGE, v_SSOUND, C7.Get("CUSTFIEL1SPE"), C7.Get("CUSTFIEL2SPE"));
          ...
          {
            WriteDebug(IDL.FormatMessage((new IDVariant("Trovato errore. Disattivo l'applicazione IDAppspushSetting:|1")), IDL.ToString(v_VIDAPPPUSSET)), (new IDVariant(1)), (new IDVariant("Main server session - IOS")));
            SQL = new StringBuilder();
            SQL.Append("update APPS_PUSH_SETTING set ");
            SQL.Append("  FLG_ATTIVA = 'N', ");
