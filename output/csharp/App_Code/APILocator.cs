...
public partial class APILocator : MyWebForm
{
  ...
  private const int PFL_APILOCATOR_MESSADIBLOCC = 5;
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_DETTAGLIAPP, 6);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 716-MyGlb.PAN_OFFS_X, 304-MyGlb.PAN_OFFS_Y, 0, 0);
    ...
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 716-MyGlb.PAN_OFFS_X, 252-MyGlb.PAN_OFFS_Y- MyGlb.PAN_OFFS_PAGEY, 0, 0);
    PAN_APILOCATOR.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "373E0E65-365A-45BA-A24B-807DD649C2F6");
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 656, 176, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
    ...
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 716-MyGlb.PAN_OFFS_X, 188-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_DETTAGVERSIO.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "50F256C7-C8F1-4C1F-9894-CD6B0816F00E");
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 656, 136, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_APILOCATOR1_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_ID1, MyGlb.PANEL_LIST, 0, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_ID1, PPQRY_APILOCATOR, "A.ID", "ID", 1, 9, 0, -685);
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_APPLICAZIONE, MyGlb.PANEL_LIST, 0, 36, 384, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetNumRow(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_APPLICAZIONE, MyGlb.PANEL_FORM, 2);
    ...
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_APPLICAZIONE, PPQRY_APILOCATOR, "A.NOME_APP", "NOME_APP", 5, 200, 0, -685);
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_CHIAVE, MyGlb.PANEL_LIST, 116, 36, 116, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_CHIAVE, PPQRY_APILOCATOR, "A.APP_KEY", "APP_KEY", 5, 300, 0, -685);
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_AUTHKEY, MyGlb.PANEL_LIST, 116, 36, 152, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_AUTHKEY, PPQRY_APILOCATOR, "A.AUTH_KEY", "AUTH_KEY", 5, 1000, 0, -685);
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_NOTA1, MyGlb.PANEL_LIST, 384, 36, 104, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_NOTA1, PPQRY_APILOCATOR, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -685);
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_PRODOTTO, MyGlb.PANEL_LIST, 488, 36, 68, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_PRODOTTO, PPQRY_APILOCATOR, "A.ID_PRODOTTO", "ID_PRODOTTO", 1, 9, 0, -685);
    PAN_APILOCATOR1.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_TITOLOSTATIS, MyGlb.PANEL_LIST, 556, 36, 100, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR1.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_TITOLOSTATIS, MyGlb.PANEL_LIST, "Titolo Statistiche");
    ...
    PAN_APILOCATOR1.SetNumRow(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_TITOLOSTATIS, MyGlb.PANEL_FORM, 2);
    PAN_APILOCATOR1.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APILOCATOR1_TITOLOSTATIS, MyGlb.PANEL_FORM, "Titolo Statistiche");
    PAN_APILOCATOR1.SetFieldPage(PFL_APILOCATOR1_TITOLOSTATIS, -1, -1);
    PAN_APILOCATOR1.SetFieldPanel(PFL_APILOCATOR1_TITOLOSTATIS, PPQRY_APILOCATOR, "A.NOME_APP_STAT", "NOME_APP_STAT", 5, 200, 0, -685);
  }
  ...
  private void PAN_APILOCATOR1_InitQueries()
  {
    ...
    PAN_APILOCATOR1.SetQueryDB(PPQRY_PRODOTTI, MainFrm.NotificatoreDBObject.DB, 2048);
    ...
    PAN_APILOCATOR1.SetQueryDB(PPQRY_APILOCATOR, MainFrm.NotificatoreDBObject.DB, 2048);
  ...
  private void PAN_APILOCATOR_Init()
  {
    ...
    PAN_APILOCATOR.SetSize(MyGlb.OBJ_FIELD, 6);
  ...
  private void PAN_APILOCATOR_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR_ID2, MyGlb.PANEL_LIST, 0, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR.SetFieldPanel(PFL_APILOCATOR_ID2, PPQRY_DETTAGLIAPP, "A.ID", "ID", 1, 9, 0, -685);
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR_IDAPP1, MyGlb.PANEL_LIST, 40, 36, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR.SetFieldPanel(PFL_APILOCATOR_IDAPP1, PPQRY_DETTAGLIAPP, "A.ID_APP", "ID_APP", 1, 9, 0, -685);
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR_VERSIONE, MyGlb.PANEL_LIST, 0, 36, 76, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR.SetNumRow(MyGlb.OBJ_FIELD, PFL_APILOCATOR_VERSIONE, MyGlb.PANEL_FORM, 2);
    ...
    PAN_APILOCATOR.SetFieldPanel(PFL_APILOCATOR_VERSIONE, PPQRY_DETTAGLIAPP, "A.DES_VERSIONE", "DES_VERSIONE", 5, 200, 0, -685);
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR_NOTA2, MyGlb.PANEL_LIST, 76, 36, 196, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APILOCATOR_NOTA2, MyGlb.PANEL_FORM, "Nota");
    PAN_APILOCATOR.SetFieldPage(PFL_APILOCATOR_NOTA2, -1, -1);
    PAN_APILOCATOR.SetFieldPanel(PFL_APILOCATOR_NOTA2, PPQRY_DETTAGLIAPP, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -685);
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR_BLOCCA, MyGlb.PANEL_LIST, 272, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APILOCATOR_BLOCCA, MyGlb.PANEL_LIST, "Blocca");
    ...
    PAN_APILOCATOR.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APILOCATOR_BLOCCA, MyGlb.PANEL_FORM, "Blocca");
    PAN_APILOCATOR.SetFieldPage(PFL_APILOCATOR_BLOCCA, -1, -1);
    PAN_APILOCATOR.SetFieldPanel(PFL_APILOCATOR_BLOCCA, PPQRY_DETTAGLIAPP, "A.FLG_BLOCCO", "FLG_BLOCCO", 5, 1, 0, -685);
    ...
    PAN_APILOCATOR.SetRect(MyGlb.OBJ_FIELD, PFL_APILOCATOR_MESSADIBLOCC, MyGlb.PANEL_LIST, 312, 36, 344, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APILOCATOR.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APILOCATOR_MESSADIBLOCC, MyGlb.PANEL_FORM, "Messaggio di blocco");
    PAN_APILOCATOR.SetFieldPage(PFL_APILOCATOR_MESSADIBLOCC, -1, -1);
    PAN_APILOCATOR.SetFieldPanel(PFL_APILOCATOR_MESSADIBLOCC, PPQRY_DETTAGLIAPP, "A.DES_MSG", "DES_MSG", 5, 2000, 0, -685);
  }
  ...
  private void PAN_APILOCATOR_InitQueries()
  {
    ...
    PAN_APILOCATOR.SetQueryDB(PPQRY_DETTAGLIAPP, MainFrm.NotificatoreDBObject.DB, 2048);
    PAN_APILOCATOR.SetMasterTable(0, "APP_DETAILS");
    PAN_APILOCATOR.AddToSortList(PFL_APILOCATOR_VERSIONE, false);
    SQL = new StringBuilder("select APP_DETAILS_ID.NextVal from dual");
  ...
  private void PAN_DETTAGVERSIO_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_ID, MyGlb.PANEL_LIST, 0, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DETTAGVERSIO.SetFieldPanel(PFL_DETTAGVERSIO_ID, PPQRY_DETTAGVERSIO, "A.ID", "ID", 1, 9, 0, -685);
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_IDDETTAGLAPP, MyGlb.PANEL_LIST, 40, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DETTAGVERSIO.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_IDDETTAGLAPP, MyGlb.PANEL_LIST, "ID Dtt. App");
    ...
    PAN_DETTAGVERSIO.SetFieldPanel(PFL_DETTAGVERSIO_IDDETTAGLAPP, PPQRY_DETTAGVERSIO, "A.ID_DETT_APP", "ID_DETT_APP", 1, 9, 0, -685);
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_APIURL, MyGlb.PANEL_LIST, 0, 36, 372, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DETTAGVERSIO.SetNumRow(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_APIURL, MyGlb.PANEL_FORM, 2);
    ...
    PAN_DETTAGVERSIO.SetFieldPanel(PFL_DETTAGVERSIO_APIURL, PPQRY_DETTAGVERSIO, "A.APP_URL", "APP_URL", 5, 200, 0, -685);
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_NOTA, MyGlb.PANEL_LIST, 372, 36, 196, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DETTAGVERSIO.SetFieldPanel(PFL_DETTAGVERSIO_NOTA, PPQRY_DETTAGVERSIO, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -685);
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_ORDINAMENTO, MyGlb.PANEL_LIST, 568, 36, 44, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DETTAGVERSIO.SetFieldPanel(PFL_DETTAGVERSIO_ORDINAMENTO, PPQRY_DETTAGVERSIO, "A.ORDINAMENTO", "ORDINAMENTO", 1, 10, 0, -685);
    PAN_DETTAGVERSIO.SetRect(MyGlb.OBJ_FIELD, PFL_DETTAGVERSIO_ATTIVA, MyGlb.PANEL_LIST, 612, 36, 44, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DETTAGVERSIO.SetFieldPanel(PFL_DETTAGVERSIO_ATTIVA, PPQRY_DETTAGVERSIO, "A.FLG_ATTIVA", "FLG_ATTIVA", 5, 1, 0, -685);
  ...
  private void PAN_DETTAGVERSIO_InitQueries()
  {
    ...
    PAN_DETTAGVERSIO.SetQueryDB(PPQRY_DETTAGVERSIO, MainFrm.NotificatoreDBObject.DB, 2048);
    PAN_DETTAGVERSIO.SetMasterTable(0, "REL_DETAILS");
    PAN_DETTAGVERSIO.AddToSortList(PFL_DETTAGVERSIO_ORDINAMENTO, true);
    SQL = new StringBuilder("select REL_DETAILS_ID.NextVal from dual");
