...
public partial class TestSpedizione : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 900-MyGlb.PAN_OFFS_X, 416-MyGlb.PAN_OFFS_Y, 0, 0);
    ...
    PAN_DATITEMP.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 900-MyGlb.PAN_OFFS_X, 116-MyGlb.PAN_OFFS_Y, 0, 0);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 900-MyGlb.PAN_OFFS_X, 220-MyGlb.PAN_OFFS_Y, 0, 0);
  ...
  private void PAN_SPEDIZIONI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_ID1, MyGlb.PANEL_LIST, 0, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_ID1, MyGlb.PANEL_FORM, 4, 4, 156, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_ID1, PPQRY_SPEDIZIONI, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_IDAPPSPUSSE1, MyGlb.PANEL_LIST, 40, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_IDAPPSPUSSE1, MyGlb.PANEL_LIST, "I. A. P. S.");
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_IDAPPSPUSSE1, MyGlb.PANEL_FORM, 188, 4, 176, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_IDAPPSPUSSE1, MyGlb.PANEL_FORM, "ID App. Psh. Sett.");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_IDAPPSPUSSE1, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_IDAPPSPUSSE1, PPQRY_SPEDIZIONI, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, MyGlb.PANEL_LIST, 80, 32, 64, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, MyGlb.PANEL_FORM, 372, 4, 160, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_STATO, PPQRY_SPEDIZIONI, "A.FLG_STATO", "FLG_STATO", 5, 1, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, MyGlb.PANEL_LIST, 144, 32, 48, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, MyGlb.PANEL_FORM, 540, 4, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_BADGE, PPQRY_SPEDIZIONI, "A.BADGE", "BADGE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_LIST, 424, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_FORM, 656, 4, 152, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_NUMEROTENTAT, PPQRY_SPEDIZIONI, "A.TENTATIVI", "TENTATIVI", 1, 3, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAINSERIME, MyGlb.PANEL_FORM, 4, 36, 228, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAINSERIME, PPQRY_SPEDIZIONI, "A.DAT_CREAZ", "DAT_CREAZ", 8, 61, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAELABORAZ, MyGlb.PANEL_FORM, 256, 36, 248, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAELABORAZ, PPQRY_SPEDIZIONI, "A.DAT_ELAB", "DAT_ELAB", 8, 61, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_TYPEOS, MyGlb.PANEL_LIST, 192, 32, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_TYPEOS, MyGlb.PANEL_FORM, 540, 40, 240, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_TYPEOS, PPQRY_SPEDIZIONI, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_UTENTE1, MyGlb.PANEL_FORM, 4, 68, 324, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_UTENTE1, PPQRY_SPEDIZIONI, "A.DES_UTENTE", "DES_UTENTE", 5, 1000, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_SOUND, MyGlb.PANEL_FORM, 340, 72, 284, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_SOUND, PPQRY_SPEDIZIONI, "A.SOUND", "SOUND", 5, 200, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, MyGlb.PANEL_FORM, 4, 108, 324, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DEVICETOKEN, PPQRY_SPEDIZIONI, "A.DEV_TOKEN", "DEV_TOKEN", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_LIST, 296, 32, 128, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_FORM, 4, 144, 324, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_GUIDGRUPINVI, PPQRY_SPEDIZIONI, "A.GUID_GRUPPO", "GUID_GRUPPO", 5, 200, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GOOGLEAPI, MyGlb.PANEL_LIST, 0, 32, 508, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GOOGLEAPI, MyGlb.PANEL_FORM, 336, 144, 472, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_GOOGLEAPI, PPQRY_LOOAPPPUSSE1, "A.GOOGLE_API_ID", "GOAPBRIAPSNO", 5, 100, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID1, MyGlb.PANEL_LIST, 1);
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID1, MyGlb.PANEL_LIST, "Regid");
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID1, MyGlb.PANEL_FORM, 4, 180, 804, 64, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_REGID1, PPQRY_SPEDIZIONI, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_FORM, 4, 252, 804, 64, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_MESSAGGIO, PPQRY_SPEDIZIONI, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_FORM, 4, 324, 700, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_INFO, PPQRY_SPEDIZIONI, "A.INFO", "INFO", 5, 2000, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_ETICHETINVIA, MyGlb.PANEL_FORM, 716, 324, 108, 40, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_ETICHETINVIA, -1, "", "ETICHETINVIA", 0, 0, 0, -1709);
  }
  ...
  private void PAN_DATITEMP_InitFields()
  {
    ...
    PAN_DATITEMP.SetNumRow(MyGlb.OBJ_FIELD, PFL_DATITEMP_JSONRITORNO, MyGlb.PANEL_FORM, 5);
    ...
    PAN_DATITEMP.SetFieldPanel(PFL_DATITEMP_JSONRITORNO, PPQRY_DATITEMP1, "A.JSORITNOMOGG", "JSORITNOMOGG", 9, 5000, 0, -1709);
    ...
    PAN_DATITEMP.SetFieldPanel(PFL_DATITEMP_ETICELABRISU, -1, "", "ETICELABRISU", 0, 0, 0, -1709);
  }
  ...
  private void PAN_DEVICETOKEN_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ID, MyGlb.PANEL_LIST, 0, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ID, MyGlb.PANEL_FORM, 4, 4, 104, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ID, PPQRY_DEVICETOKEN5, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DEVTOKEN, MyGlb.PANEL_LIST, 40, 32, 396, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DEVTOKEN, MyGlb.PANEL_FORM, 120, 4, 368, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DEVTOKEN, PPQRY_DEVICETOKEN5, "A.DEV_TOKEN", "DEV_TOKEN", 5, 200, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_UTENTE, MyGlb.PANEL_FORM, 492, 4, 288, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_UTENTE, PPQRY_DEVICETOKEN5, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ATTIVO, MyGlb.PANEL_LIST, 476, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ATTIVO, MyGlb.PANEL_FORM, 4, 40, 104, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ATTIVO, PPQRY_DEVICETOKEN5, "A.FLG_ATTIVO", "FLG_ATTIVO", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_RIMOSSO, MyGlb.PANEL_LIST, 532, 32, 64, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_RIMOSSO, MyGlb.PANEL_FORM, 116, 40, 104, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_RIMOSSO, MyGlb.PANEL_FORM, "Rim.");
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_RIMOSSO, -1, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_RIMOSSO, PPQRY_DEVICETOKEN5, "A.FLG_RIMOSSO", "FLG_RIMOSSO", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATARIMOZION, MyGlb.PANEL_FORM, 228, 40, 260, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATARIMOZION, MyGlb.PANEL_FORM, "Dt. Rimozione");
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_DATARIMOZION, -1, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATARIMOZION, PPQRY_DEVICETOKEN5, "A.DATA_RIMOZ", "DATA_RIMOZ", 8, 61, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_NOTA, MyGlb.PANEL_FORM, 4, 72, 776, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_NOTA, PPQRY_DEVICETOKEN5, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetNumRow(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_REGID, MyGlb.PANEL_LIST, 1);
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_REGID, MyGlb.PANEL_LIST, "Regid");
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_REGID, MyGlb.PANEL_FORM, 4, 108, 776, 56, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_REGID, PPQRY_DEVICETOKEN5, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDAPPSPUSSET, MyGlb.PANEL_LIST, 0, 32, 116, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDAPPSPUSSET, MyGlb.PANEL_LIST, "ID App. Psh. Sett.");
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDAPPSPUSSET, MyGlb.PANEL_FORM, "ID App. Psh. Sett.");
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_IDAPPSPUSSET, -1, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_IDAPPSPUSSET, PPQRY_DEVICETOKEN5, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
  }
