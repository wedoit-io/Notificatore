...
public partial class TestSpedizione : MyWebForm
{
  ...
  private void PAN_SPEDIZIONI_InitQueries()
  {
    ...
    PAN_SPEDIZIONI.SetQueryDB(PPQRY_LOOAPPPUSSE1, MainFrm.NotificatoreDBObject.DB, 2048);
    ...
    PAN_SPEDIZIONI.SetQueryDB(PPQRY_APPSPUSHSETT, MainFrm.NotificatoreDBObject.DB, 2048);
    ...
    PAN_SPEDIZIONI.SetQueryDB(PPQRY_SPEDIZIONI, MainFrm.NotificatoreDBObject.DB, 2048);
  ...
  private void PAN_DEVICETOKEN_InitQueries()
  {
    ...
    PAN_DEVICETOKEN.SetQueryDB(PPQRY_DEVICETOKEN5, MainFrm.NotificatoreDBObject.DB, 2048);
