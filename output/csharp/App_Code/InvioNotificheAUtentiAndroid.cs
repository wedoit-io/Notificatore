...
public partial class InvioNotificheAUtentiAndroid : MyWebForm
{
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_NOTIFICHE, 7);
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NOTIFICHE1, 6);
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NOTIFICHE1_RS, 6);
  ...
  private void PAN_NUOVOPANNELL_InitFields()
  {
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_APPLICAZIONE, PPQRY_NOTIFICHE1, "A.IDAPPLINOTIF", "IDAPPLINOTIF", 1, 52, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_UTENTE, PPQRY_NOTIFICHE1, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_MESSAGGIO, PPQRY_NOTIFICHE1, "A.MESSAGNOTIFI", "MESSAGNOTIFI", 9, 500, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_AMBIENTE, PPQRY_NOTIFICHE1, "A.AMBIENNOTIFI", "AMBIENNOTIFI", 5, 1, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_SOUND, PPQRY_NOTIFICHE1, "A.SOUND", "SOUND", 5, 200, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_BADGE, PPQRY_NOTIFICHE1, "A.BADGE", "BADGE", 1, 9, 0, -685);
  }
