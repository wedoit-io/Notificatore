...
public partial class LoginIphone : MyWebForm
{
  ...
  private void PAN_LOGIN_InitFields()
  {
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_EMAIL, PPQRY_DATIDILOGIN2, "A.EMAINUOVPANN", "EMAINUOVPANN", 5, 255, 0, -685);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_PIN, PPQRY_DATIDILOGIN2, "A.PINNUOVOPANN", "PINNUOVOPANN", 5, 255, 0, -685);
    ...
    PAN_LOGIN.SetNumRow(MyGlb.OBJ_FIELD, PFL_LOGIN_LOGO, MyGlb.PANEL_FORM, 6);
    PAN_LOGIN.SetFieldPage(PFL_LOGIN_LOGO, -1, -1);
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_LOGO, -1, "", "LOGO", 0, 0, 0, -685);
    ...
    PAN_LOGIN.SetNumRow(MyGlb.OBJ_FIELD, PFL_LOGIN_ETICHESCRIVI, MyGlb.PANEL_FORM, 3);
