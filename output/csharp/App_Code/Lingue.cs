...
public partial class Lingue : MyWebForm
{
  ...
  private void PAN_LINGUE_InitFields()
  {
    ...
    PAN_LINGUE.SetNumRow(MyGlb.OBJ_FIELD, PFL_LINGUE_DESCRIZIONE, MyGlb.PANEL_FORM, 1);
    ...
    PAN_LINGUE.SetFieldPanel(PFL_LINGUE_CODICELINGUA, PPQRY_LINGUE, "A.CDA_LINGUA", "CDA_LINGUA", 5, 10, 0, -1709);
  }
