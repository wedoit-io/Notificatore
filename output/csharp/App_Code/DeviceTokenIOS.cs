...
public partial class DeviceTokenIOS : MyWebForm
{
  ...
  private const int PFL_DEVICETOKEN_IDLINGUA = 9;
  private const int PFL_DEVICETOKEN_DATAULTIINVI = 10;
  private const int PFL_DEVICETOKEN_DATACUPERTIN = 11;
  private const int PFL_DEVICETOKEN_NOTA = 12;
  private const int PFL_DEVICETOKEN_CUSTOMTAG = 13;
  private const int PFL_DEVICETOKEN_DATARIMOZION = 14;
  private const int PFL_DEVICETOKEN_TYPEOS = 15;
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 864-MyGlb.PAN_OFFS_X, 576-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_DEVICETOKEN.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "CA8E9332-E979-4328-98CD-790E23C604CB");
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 804, 496, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_DEVICETOKEN_InitFields()
  {
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ID, PPQRY_DEVICETOKEN1, "A.ID", "ID", 1, 9, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_APPLICAZIONE, MyGlb.PANEL_LIST, 0, 36, 192, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_APPLICAZIONE, PPQRY_DEVICETOKEN1, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DEVTOKEN, MyGlb.PANEL_LIST, 192, 36, 76, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DEVTOKEN, PPQRY_DEVICETOKEN1, "A.DEV_TOKEN", "DEV_TOKEN", 5, 200, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATA, MyGlb.PANEL_LIST, 268, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATA, PPQRY_DEVICETOKEN1, "A.DATA_CREAZIONE", "DATA_CREAZIONE", 8, 61, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATAULTIACCE, MyGlb.PANEL_LIST, 372, 36, 108, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIACCE, PPQRY_DEVICETOKEN1, "A.DATA_ULT_ACCESSO", "DATA_ULT_ACCESSO", 8, 61, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DISPOSITNOTI, MyGlb.PANEL_LIST, 480, 36, 68, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DISPOSITNOTI, MyGlb.PANEL_LIST, "Dispositivi Noti");
  ...
  SQL.Append(")");
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DISPOSITNOTI, PPQRY_DEVICETOKEN1, SQL.ToString(), "DISNOTDEVTOK", 9, 1000, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_UTENTE, MyGlb.PANEL_LIST, 548, 36, 92, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_UTENTE, PPQRY_DEVICETOKEN1, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ATTIVO, MyGlb.PANEL_LIST, 640, 36, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ATTIVO, PPQRY_DEVICETOKEN1, "A.FLG_ATTIVO", "FLG_ATTIVO", 5, 1, 0, -685);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_RIMOSSO, MyGlb.PANEL_LIST, 696, 36, 52, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_RIMOSSO, PPQRY_DEVICETOKEN1, "A.FLG_RIMOSSO", "FLG_RIMOSSO", 5, 1, 0, -685);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDLINGUA, MyGlb.PANEL_LIST, 748, 36, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_IDLINGUA, PAG_DEVICETOKEN_PRINCIPALE, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_IDLINGUA, PPQRY_DEVICETOKEN1, "A.PRG_LINGUA", "PRG_LINGUA", 1, 9, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATAULTIINVI, MyGlb.PANEL_LIST, 192, 36, 116, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIINVI, PPQRY_DEVICETOKEN1, "A.DAT_ULTIMO_INVIO", "DAT_ULTIMO_INVIO", 8, 19, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATACUPERTIN, MyGlb.PANEL_LIST, 672, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATACUPERTIN, PPQRY_DEVICETOKEN1, "A.DATA_CUPERTINO", "DATA_CUPERTINO", 8, 61, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_NOTA, MyGlb.PANEL_LIST, 308, 36, 124, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_NOTA, PPQRY_DEVICETOKEN1, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_CUSTOMTAG, MyGlb.PANEL_LIST, 432, 36, 116, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_CUSTOMTAG, PPQRY_DEVICETOKEN1, "A.CUSTOM_TAG", "CUSTOM_TAG", 5, 200, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATARIMOZION, MyGlb.PANEL_LIST, 548, 36, 96, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATARIMOZION, PPQRY_DEVICETOKEN1, "A.DATA_RIMOZ", "DATA_RIMOZ", 8, 61, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_TYPEOS, MyGlb.PANEL_LIST, 848, 36, 72, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_TYPEOS, PPQRY_DEVICETOKEN1, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -685);
  ...
  private void PAN_DEVICETOKEN_InitQueries()
  {
    ...
    PAN_DEVICETOKEN.SetQueryDB(PPQRY_DEVICETOKEN1, MainFrm.NotificatoreDBObject.DB, 2048);
