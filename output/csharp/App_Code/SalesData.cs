...
public partial class SalesData : MyWebForm
{
  ...
  private void PAN_SALESDATA_InitFields()
  {
    ...
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_PROVIDER, MyGlb.PANEL_LIST, 0, 32, 48, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_PROVIDER, MyGlb.PANEL_LIST, "Prov.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_PROVIDER, PPQRY_SALESDATA1, "A.PROVIDER", "PROVIDER", 5, 5, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_PROVIDCOUNTR, MyGlb.PANEL_LIST, 48, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_PROVIDCOUNTR, MyGlb.PANEL_LIST, "Pr. C.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_PROVIDCOUNTR, PPQRY_SALESDATA1, "A.PROVIDER_COUNTRY", "PROVIDER_COUNTRY", 5, 2, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_BEGINDATE, MyGlb.PANEL_LIST, 88, 32, 84, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_BEGINDATE, PPQRY_SALESDATA1, "A.BEGIN_DATE", "BEGIN_DATE", 6, 52, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_ENDDATE, MyGlb.PANEL_LIST, 172, 32, 84, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_ENDDATE, PPQRY_SALESDATA1, "A.END_DATE", "END_DATE", 6, 52, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_SKUNUMBER, MyGlb.PANEL_LIST, 256, 32, 92, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_SKUNUMBER, PPQRY_SALESDATA1, "A.SKU_NUMBER", "SKU_NUMBER", 5, 50, 0, -1709);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_DEVELOPER, PPQRY_SALESDATA1, "A.DEVELOPER", "DEVELOPER", 5, 2000, 0, -1709);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_TITLE, PPQRY_SALESDATA1, "A.TITLE", "TITLE", 5, 600, 0, -1709);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_VERSION, PPQRY_SALESDATA1, "A.VERSION", "VERSION", 5, 100, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_PRODTYPEIDEN, MyGlb.PANEL_LIST, 348, 32, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_PRODTYPEIDEN, MyGlb.PANEL_LIST, "Prod. Typ. Ident.");
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_PRODTYPEIDEN, MyGlb.PANEL_FORM, "Prod. Type Identifiers");
    PAN_SALESDATA.SetFieldPage(PFL_SALESDATA_PRODTYPEIDEN, -1, -1);
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_PRODTYPEIDEN, PPQRY_SALESDATA1, "A.PROD_TYPE_IDENTIFIER", "PROD_TYPE_IDENTIFIER", 5, 20, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_UNITS, MyGlb.PANEL_LIST, 452, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_UNITS, PPQRY_SALESDATA1, "A.UNITS", "UNITS", 3, 18, 2, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_DEVELOPROCEE, MyGlb.PANEL_LIST, 508, 32, 108, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_DEVELOPROCEE, MyGlb.PANEL_LIST, "Devel. Proceed");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_DEVELOPROCEE, PPQRY_SALESDATA1, "A.DEV_PROCEED", "DEV_PROCEED", 3, 18, 2, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_CUSTOMCURREN, MyGlb.PANEL_LIST, 616, 32, 60, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_CUSTOMCURREN, MyGlb.PANEL_LIST, "Cst. Crr.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_CUSTOMCURREN, PPQRY_SALESDATA1, "A.CUST_CURRENCY", "CUST_CURRENCY", 5, 3, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_COUNTRYCODE, MyGlb.PANEL_LIST, 676, 32, 64, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_COUNTRYCODE, MyGlb.PANEL_LIST, "Coun. Cd.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_COUNTRYCODE, PPQRY_SALESDATA1, "A.COUNTRY_CODE", "COUNTRY_CODE", 5, 3, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_CURRENPROCEE, MyGlb.PANEL_LIST, 740, 32, 68, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_CURRENPROCEE, MyGlb.PANEL_LIST, "Curr. Proc.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_CURRENPROCEE, PPQRY_SALESDATA1, "A.CURRENCY_PROCEED", "CURRENCY_PROCEED", 5, 3, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_APPLEIDENTIF, MyGlb.PANEL_LIST, 808, 32, 80, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_APPLEIDENTIF, MyGlb.PANEL_LIST, "App. Ident.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_APPLEIDENTIF, PPQRY_SALESDATA1, "A.APPLE_IDENTIFIER", "APPLE_IDENTIFIER", 5, 18, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_CUSTOMEPRICE, MyGlb.PANEL_LIST, 888, 32, 72, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_CUSTOMEPRICE, MyGlb.PANEL_LIST, "Cust. Price");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_CUSTOMEPRICE, PPQRY_SALESDATA1, "A.CUSTOMER_PRICE", "CUSTOMER_PRICE", 3, 18, 2, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_PROMOCODE, MyGlb.PANEL_LIST, 960, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_PROMOCODE, MyGlb.PANEL_LIST, "Pr. C.");
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_PROMOCODE, PPQRY_SALESDATA1, "A.CODE", "CODE", 5, 10, 0, -1709);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_PARENTIDENTI, PPQRY_SALESDATA1, "A.PARENT_IDENTIFIER", "PARENT_IDENTIFIER", 5, 100, 0, -1709);
    ...
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_SUBSFIELVALU, MyGlb.PANEL_LIST, "Subscr. Field Value");
    ...
    PAN_SALESDATA.SetNumRow(MyGlb.OBJ_FIELD, PFL_SALESDATA_SUBSFIELVALU, MyGlb.PANEL_FORM, 1);
    PAN_SALESDATA.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SALESDATA_SUBSFIELVALU, MyGlb.PANEL_FORM, "Subscr. Field Value");
    PAN_SALESDATA.SetFieldPage(PFL_SALESDATA_SUBSFIELVALU, -1, -1);
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_SUBSFIELVALU, PPQRY_SALESDATA1, "A.SUBSCRIPTION", "SUBSCRIPTION", 5, 200, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_PERIOD, MyGlb.PANEL_LIST, 1000, 32, 136, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_PERIOD, PPQRY_SALESDATA1, "A.PERIOD", "PERIOD", 5, 30, 0, -1709);
    PAN_SALESDATA.SetRect(MyGlb.OBJ_FIELD, PFL_SALESDATA_ID, MyGlb.PANEL_LIST, 0, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SALESDATA.SetFieldPanel(PFL_SALESDATA_ID, PPQRY_SALESDATA1, "A.ID", "ID", 1, 9, 0, -1709);
  }
  ...
  private void PAN_SALESDATA_InitQueries()
  {
    ...
    PAN_SALESDATA.SetQueryDB(PPQRY_PRODTYPEIDEN, MainFrm.NotificatoreDBObject.DB, 256);
    SQL = new StringBuilder();
    SQL.Append("select ");
    ...
    PAN_SALESDATA.SetQueryDB(PPQRY_CURRENCIES1, MainFrm.NotificatoreDBObject.DB, 256);
    SQL = new StringBuilder();
    SQL.Append("select ");
    ...
    PAN_SALESDATA.SetQueryDB(PPQRY_COUNTRYCODES, MainFrm.NotificatoreDBObject.DB, 256);
    SQL = new StringBuilder();
    SQL.Append("select ");
    SQL.Append("  A.CODE as CODECURRENCY, ");
    SQL.Append("  A.DESCRIPTION as DESCRICURREN ");
    ...
    PAN_SALESDATA.SetQueryDB(PPQRY_CURRENCIES, MainFrm.NotificatoreDBObject.DB, 256);
    SQL = new StringBuilder();
    SQL.Append("select ");
    ...
    PAN_SALESDATA.SetQueryDB(PPQRY_PROMOCODES, MainFrm.NotificatoreDBObject.DB, 256);
    ...
    PAN_SALESDATA.SetQueryDB(PPQRY_SALESDATA1, MainFrm.NotificatoreDBObject.DB, 256);
