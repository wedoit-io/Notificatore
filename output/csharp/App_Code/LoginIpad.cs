...
public partial class LoginIpad : MyWebForm
{
  ...
  private void PAN_LOGIN_InitFields()
  {
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_EMAIL, PPQRY_DATIDILOGIN1, "A.EMAINUOVPANN", "EMAINUOVPANN", 5, 255, 0, -685);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_PIN, PPQRY_DATIDILOGIN1, "A.PINNUOVOPANN", "PINNUOVOPANN", 5, 255, 0, -685);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_BOTTONELOGIN, -1, "", "BOTTONELOGIN", 0, 0, 0, -685);
    ...
    PAN_LOGIN.SetNumRow(MyGlb.OBJ_FIELD, PFL_LOGIN_BENVEINISPES, MyGlb.PANEL_FORM, 13);
    PAN_LOGIN.SetFieldPage(PFL_LOGIN_BENVEINISPES, -1, -1);
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_BENVEINISPES, -1, "", "BENVEINISPES", 0, 0, 0, -685);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_ETICHESCRIVI, -1, "", "ETICHESCRIVI", 0, 0, 0, -685);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_BENVEINISPE1, -1, "", "BENVEINISPE1", 0, 0, 0, -685);
    PAN_LOGIN.set_ImageResizeMode(PFL_LOGIN_BENVEINISPE1, 3);
    PAN_LOGIN.SetRect(MyGlb.OBJ_FIELD, PFL_LOGIN_IDCOMUNE, MyGlb.PANEL_LIST, 0, 36, 116, 24, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_IDCOMUNE, PPQRY_DATIDILOGIN1, "A.COMUTENUOPAN", "COMUTENUOPAN", 1, 6, 0, -685);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_ETICILSISPIU, -1, "", "ETICILSISPIU", 0, 0, 0, -685);
    PAN_LOGIN.SetRect(MyGlb.OBJ_FIELD, PFL_LOGIN_PASSWOUTENTE, MyGlb.PANEL_LIST, 0, 36, 84, 24, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_LOGIN.SetFieldPanel(PFL_LOGIN_PASSWOUTENTE, PPQRY_DATIDILOGIN1, "A.PASUTENUOPAN", "PASUTENUOPAN", 5, 10, 0, -685);
  }
