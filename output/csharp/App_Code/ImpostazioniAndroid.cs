...
public partial class ImpostazioniAndroid : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 868, 492, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_APPSPUSHSETT_Init()
  {
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_GOOGLEACCOUN, MyGlb.PANEL_LIST, 216, -9999, 376, 22, 0, 0);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_GOOGLEACCOUN, MyGlb.PANEL_FORM, 4, 212, 516, 88, 0, 0);
    PAN_APPSPUSHSETT.SetHeaderSize(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_GOOGLEACCOUN, 0, 88);
    PAN_APPSPUSHSETT.SetHeaderSize(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_GOOGLEACCOUN, 1, 15);
  ...
  private void PAN_APPSPUSHSETT_InitFields()
  {
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ID, PPQRY_APPLICAZION3, "A.ID", "ID", 1, 9, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_APPLICAZIONE, PPQRY_APPLICAZION3, "A.ID_APP", "ID_APP", 1, 9, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_USERNAME, MyGlb.PANEL_LIST, 216, 44, 148, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_USERNAME, PPQRY_APPLICAZION3, "A.GOOGLE_USERNAME", "GOOGLE_USERNAME", 5, 1000, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_GOOGLEPASSWO, MyGlb.PANEL_LIST, 364, 44, 96, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_GOOGLEPASSWO, MyGlb.PANEL_LIST, "Goog. Passw.");
    ...
    PAN_APPSPUSHSETT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_GOOGLEPASSWO, MyGlb.PANEL_FORM, "Goog. Password");
    PAN_APPSPUSHSETT.SetFieldPage(PFL_APPSPUSHSETT_GOOGLEPASSWO, -1, GRP_APPSPUSHSETT_GOOGLEACCOUN);
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_GOOGLEPASSWO, PPQRY_APPLICAZION3, "A.GOOGLE_PASSWORD", "GOOGLE_PASSWORD", 5, 1000, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_GOOGAPIBROID, MyGlb.PANEL_LIST, 460, 44, 132, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_GOOGAPIBROID, MyGlb.PANEL_LIST, "Goog. Api Browser ID");
    ...
    PAN_APPSPUSHSETT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_GOOGAPIBROID, MyGlb.PANEL_FORM, "Gg. Api Brow. ID");
    PAN_APPSPUSHSETT.SetFieldPage(PFL_APPSPUSHSETT_GOOGAPIBROID, -1, GRP_APPSPUSHSETT_GOOGLEACCOUN);
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_GOOGAPIBROID, PPQRY_APPLICAZION3, "A.GOOGLE_API_ID", "GOOGLE_API_ID", 5, 100, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_ATTIVA, MyGlb.PANEL_LIST, 592, 44, 52, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ATTIVA, PPQRY_APPLICAZION3, "A.FLG_ATTIVA", "FLG_ATTIVA", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_AMBIENTE, MyGlb.PANEL_LIST, 644, 44, 56, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_AMBIENTE, MyGlb.PANEL_LIST, "Ambien.");
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_AMBIENTE, PPQRY_APPLICAZION3, "A.FLG_AMBIENTE", "FLG_AMBIENTE", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_NOTA, MyGlb.PANEL_LIST, 700, 44, 168, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_NOTA, PPQRY_APPLICAZION3, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_TYPEOS, PPQRY_APPLICAZION3, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
