...
public partial class Applicazioni : MyWebForm
{
  ...
  private const int PFL_APPLICAZIONI_LINGUA = 6;
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_APPLICAZION2, 7);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 740-MyGlb.PAN_OFFS_X, 348-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_APPLICAZIONI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "CBEAA1EA-F1FC-49C4-BD6C-0B1C30704DBD");
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 668, 256, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_APPLICAZIONI_Init()
  {
    ...
    PAN_APPLICAZIONI.SetSize(MyGlb.OBJ_FIELD, 7);
    ...
    PAN_APPLICAZIONI.SetFlags(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_AUTHKEY, 0 | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISOPT, -1);
  ...
  private void PAN_APPLICAZIONI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_ID, MyGlb.PANEL_LIST, 0, 32, 40, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_ID, PPQRY_APPLICAZION2, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_APPLICAZIONE, MyGlb.PANEL_LIST, 40, 32, 116, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_APPLICAZIONE, MyGlb.PANEL_FORM, 1);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_APPLICAZIONE, PPQRY_APPLICAZION2, "A.NOME_APP", "NOME_APP", 5, 200, 0, -1709);
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_CHIAVE, MyGlb.PANEL_LIST, 156, 32, 116, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_CHIAVE, PPQRY_APPLICAZION2, "A.APP_KEY", "APP_KEY", 5, 300, 0, -1709);
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_AUTHKEY, MyGlb.PANEL_LIST, 272, 32, 140, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_AUTHKEY, PPQRY_APPLICAZION2, "A.AUTH_KEY", "AUTH_KEY", 5, 1000, 0, -1709);
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_NOTA, MyGlb.PANEL_LIST, 412, 32, 104, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_NOTA, PPQRY_APPLICAZION2, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_PRODOTTO, MyGlb.PANEL_LIST, 516, 32, 72, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_PRODOTTO, PPQRY_APPLICAZION2, "A.ID_PRODOTTO", "ID_PRODOTTO", 1, 9, 0, -1709);
    PAN_APPLICAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_APPLICAZIONI_LINGUA, MyGlb.PANEL_LIST, 588, 32, 80, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPLICAZIONI.SetFieldPanel(PFL_APPLICAZIONI_LINGUA, PPQRY_APPLICAZION2, "A.PRG_LINGUA", "PRG_LINGUA", 1, 9, 0, -1709);
  }
  ...
  private void PAN_APPLICAZIONI_InitQueries()
  {
    ...
    PAN_APPLICAZIONI.SetQueryDB(PPQRY_PRODOTTI, MainFrm.NotificatoreDBObject.DB, 256);
    SQL = new StringBuilder();
    SQL.Append("select ");
    ...
    PAN_APPLICAZIONI.SetQueryDB(PPQRY_LINGUE, MainFrm.NotificatoreDBObject.DB, 256);
    ...
    PAN_APPLICAZIONI.SetQueryDB(PPQRY_APPLICAZION2, MainFrm.NotificatoreDBObject.DB, 256);
