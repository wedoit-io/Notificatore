...
public partial class GraficoAndamento : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    GRH_GRAFTEMPORAL.set_Flags(40042785);
    GRH_GRAFTEMPORAL.Height = 499;
  ...
  private void PAN_SELETTORE_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_SELETTORE.SetRect(MyGlb.OBJ_FIELD, PFL_SELETTORE_UTENTE, MyGlb.PANEL_LIST, 0, 36, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SELETTORE.SetFieldPanel(PFL_SELETTORE_UTENTE, PPQRY_SELETTGRAFI1, "A.ID_UTENTE", "ID_UTENTE", 1, 6, 0, -685);
    PAN_SELETTORE.SetRect(MyGlb.OBJ_FIELD, PFL_SELETTORE_APP, MyGlb.PANEL_LIST, 0, 36, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SELETTORE.SetFieldPanel(PFL_SELETTORE_APP, PPQRY_SELETTGRAFI1, "A.ID_APP", "ID_APP", 1, 9, 0, -685);
    PAN_SELETTORE.SetRect(MyGlb.OBJ_FIELD, PFL_SELETTORE_TIPO, MyGlb.PANEL_LIST, 0, 36, 268, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SELETTORE.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SELETTORE_TIPO, MyGlb.PANEL_FORM, "Tipo");
    PAN_SELETTORE.SetFieldPage(PFL_SELETTORE_TIPO, -1, -1);
    PAN_SELETTORE.SetFieldPanel(PFL_SELETTORE_TIPO, PPQRY_SELETTGRAFI1, "A.TIPOSELEGRAF", "TIPOSELEGRAF", 5, 1, 0, -685);
    ...
    PAN_SELETTORE.SetRect(MyGlb.OBJ_FIELD, PFL_SELETTORE_RANGE, MyGlb.PANEL_LIST, 0, 36, 268, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SELETTORE.SetFieldPanel(PFL_SELETTORE_RANGE, PPQRY_SELETTGRAFI1, "A.DATADASELGRA", "DATADASELGRA", 6, 52, 0, -685);
    PAN_SELETTORE.SetRect(MyGlb.OBJ_FIELD, PFL_SELETTORE_DATAA, MyGlb.PANEL_LIST, 0, 36, 268, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SELETTORE.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SELETTORE_DATAA, MyGlb.PANEL_FORM, "Data A");
    PAN_SELETTORE.SetFieldPage(PFL_SELETTORE_DATAA, -1, -1);
    PAN_SELETTORE.SetFieldPanel(PFL_SELETTORE_DATAA, PPQRY_SELETTGRAFI1, "A.DATAASELEGRA", "DATAASELEGRA", 6, 52, 0, -685);
  }
  ...
  private void PAN_SELETTORE_InitQueries()
  {
    ...
    PAN_SELETTORE.SetQueryDB(PPQRY_UTENTI, MainFrm.NotificatoreDBObject.DB, 2048);
    SQL = new StringBuilder();
    SQL.Append("select ");
    ...
    PAN_SELETTORE.SetQueryDB(PPQRY_APPS, MainFrm.NotificatoreDBObject.DB, 2048);
  ...
  private void PAN_DATI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_DATI.SetRect(MyGlb.OBJ_FIELD, PFL_DATI_ANNO, MyGlb.PANEL_LIST, 0, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DATI.SetFieldPanel(PFL_DATI_ANNO, PPQRY_STATAPPLE, "A.ANNO", "ANNSTAAPPREC", 1, 19, 0, -685);
    PAN_DATI.SetRect(MyGlb.OBJ_FIELD, PFL_DATI_MESE, MyGlb.PANEL_LIST, 104, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DATI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DATI_MESE, MyGlb.PANEL_FORM, "Mese");
    PAN_DATI.SetFieldPage(PFL_DATI_MESE, -1, -1);
    PAN_DATI.SetFieldPanel(PFL_DATI_MESE, PPQRY_STATAPPLE, "A.MESE", "MESSTAAPPREC", 1, 19, 0, -685);
    PAN_DATI.SetRect(MyGlb.OBJ_FIELD, PFL_DATI_GIORNO, MyGlb.PANEL_LIST, 208, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DATI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DATI_GIORNO, MyGlb.PANEL_FORM, "Giorno");
    PAN_DATI.SetFieldPage(PFL_DATI_GIORNO, -1, -1);
    PAN_DATI.SetFieldPanel(PFL_DATI_GIORNO, PPQRY_STATAPPLE, "A.GIORNO", "GIOSTAAPPREC", 1, 19, 0, -685);
    PAN_DATI.SetRect(MyGlb.OBJ_FIELD, PFL_DATI_DATA, MyGlb.PANEL_LIST, 312, 36, 112, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DATI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DATI_DATA, MyGlb.PANEL_FORM, "Data");
    PAN_DATI.SetFieldPage(PFL_DATI_DATA, -1, -1);
    PAN_DATI.SetFieldPanel(PFL_DATI_DATA, PPQRY_STATAPPLE, "A.DATA", "DATSTAAPPREC", 6, 52, 0, -685);
    PAN_DATI.SetRect(MyGlb.OBJ_FIELD, PFL_DATI_UNITS, MyGlb.PANEL_LIST, 424, 36, 148, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DATI.SetFieldPanel(PFL_DATI_UNITS, PPQRY_STATAPPLE, "SUM(A.UNITS)", "UNITSRECORD", 3, 28, 6, -685);
  }
  ...
  private void PAN_DATI_InitQueries()
  {
    ...
    PAN_DATI.SetQueryDB(PPQRY_STATAPPLE, MainFrm.NotificatoreDBObject.DB, 2048);
  ...
  private void PAN_DATENONCARIC_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_DATENONCARIC.SetRect(MyGlb.OBJ_FIELD, PFL_DATENONCARIC_DATEMANCANTI, MyGlb.PANEL_LIST, 0, 36, 268, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DATENONCARIC.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DATENONCARIC_DATEMANCANTI, MyGlb.PANEL_FORM, "dt. manc.");
    PAN_DATENONCARIC.SetFieldPage(PFL_DATENONCARIC_DATEMANCANTI, -1, -1);
    PAN_DATENONCARIC.SetFieldPanel(PFL_DATENONCARIC_DATEMANCANTI, PPQRY_SALESDATA, "A.BEGIN_DATE", "DATEMANCRECO", 6, 52, 0, -685);
  }
  ...
  private void PAN_DATENONCARIC_InitQueries()
  {
    ...
    SQL.Append(")))) ");
    SQL.Append("and   (A.BEGIN_DATE >= TO_DATE('2011-01-01','YYYY-MM-DD')) ");
    ...
    PAN_DATENONCARIC.SetQueryDB(PPQRY_SALESDATA, MainFrm.NotificatoreDBObject.DB, 2048);
