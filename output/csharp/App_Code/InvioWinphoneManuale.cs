...
public partial class InvioWinphoneManuale : MyWebForm
{
  ...
  private void PAN_PARAMETRI_InitFields()
  {
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_RISULTATO, PPQRY_NUOVATABELL1, "A.RISUNOMEOGGE", "RISUNOMEOGGE", 9, 5000, 0, -685);
    ...
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_LIST, 2);
    ...
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_FORM, 6);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_REGURL, PPQRY_NUOVATABELL1, "A.REG_ID", "REG_ID", 5, 200, 0, -685);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_MESSAGSPEDIZ, PPQRY_NUOVATABELL1, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -685);
