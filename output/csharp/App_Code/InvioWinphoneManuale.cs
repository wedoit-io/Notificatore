...
[Serializable]
public partial class InvioWinphoneManuale : MyWebForm
{
  internal MyWebEntryPoint MainFrm;

  // Frame constant definitions
  private const int PFL_PARAMETRI_RISULTATO = 0;
  private const int PFL_PARAMETRI_REGURL = 1;
  ...
  private const int PPQRY_NUOVATABELL1 = 0;
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI2, 5);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI2, "TBL_PARAMETRI2");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_DES_MESSAGGIO, "DES_MESSAGGIO");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_DES_MESSAGGIO,9,1000,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_REG_ID, "REG_ID");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_REG_ID,5,200,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_RISUNOMEOGGE, "RISUNOMEOGGE");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_RISUNOMEOGGE,9,5000,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_DEV_TOKEN, "DEV_TOKEN");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_DEV_TOKEN,5,1000,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_ID_APPLICAZIONE, "ID_APPLICAZIONE");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI2,IMDBDef1.FLD_PARAMETRI2_ID_APPLICAZIONE,1,9,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI2, 0);
  }

  private static void Init_PQRY_NUOVATABELL1(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NUOVATABELL1, 3);
    IMDB.set_TblCode(IMDBDef1.PQRY_NUOVATABELL1, "PQRY_NUOVATABELL1");
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL1,IMDBDef1.PQSL_NUOVATABELL1_DES_MESSAGGIO, "DES_MESSAGGIO");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL1,IMDBDef1.PQSL_NUOVATABELL1_DES_MESSAGGIO,9,1000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL1,IMDBDef1.PQSL_NUOVATABELL1_REG_ID, "REG_ID");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL1,IMDBDef1.PQSL_NUOVATABELL1_REG_ID,5,200,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL1,IMDBDef1.PQSL_NUOVATABELL1_RISUNOMEOGGE, "RISUNOMEOGGE");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL1,IMDBDef1.PQSL_NUOVATABELL1_RISUNOMEOGGE,9,5000,0);
    IMDB.TblAddNew(IMDBDef1.PQRY_NUOVATABELL1, 0);
  }

  private static void Init_PQRY_NUOVATABELL1_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NUOVATABELL1_RS, 3);
    IMDB.set_TblCode(IMDBDef1.PQRY_NUOVATABELL1_RS, "PQRY_NUOVATABELL1_RS");
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL1_RS,IMDBDef1.PQSL_NUOVATABELL1_DES_MESSAGGIO, "DES_MESSAGGIO");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL1_RS,IMDBDef1.PQSL_NUOVATABELL1_DES_MESSAGGIO,9,1000,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL1_RS,IMDBDef1.PQSL_NUOVATABELL1_REG_ID, "REG_ID");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL1_RS,IMDBDef1.PQSL_NUOVATABELL1_REG_ID,5,200,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL1_RS,IMDBDef1.PQSL_NUOVATABELL1_RISUNOMEOGGE, "RISUNOMEOGGE");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL1_RS,IMDBDef1.PQSL_NUOVATABELL1_RISUNOMEOGGE,9,5000,0);
  }
  ...
  // **********************************************
  public InvioWinphoneManuale(MyWebEntryPoint w, IMDBObj imdb)
    : base()
  {
    //
    SetMainFrm(w, imdb);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_INVIWINPMANU;
    //
    if (flMulti)
      MainFrm.AddMultipleForm(this, flSubForm);
    //
    //
    RTCGuid = "9911DDA7-318A-4228-A7C9-1FE96684C1B4";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 560;
    DesignHeight = 488;
    set_Caption(new IDVariant("Invio Winphone Manuale"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "9C3C2BC6-8C0E-4F12-9212-968997DDB2C5");
  ...
  public override void UpdateControls()
  {
    try
    {
      if (IMDB.TblModified(IMDBDef1.TBL_PARAMETRI2, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        INVIWINPMANU_NUOVATABELL1();
      }
  ...
  {
    return (obj is InvioWinphoneManuale);
  }
  ...
  {
    return (FullName ? typeof(InvioWinphoneManuale).FullName : typeof(InvioWinphoneManuale).Name);
  }
  ...
  public int EtichettaCreaspedizione ()
  {
    ...
    try
    {
      ...
      if (!(IDL.IsNull(IMDB.Value(IMDBDef1.TBL_PARAMETRI2, IMDBDef1.FLD_PARAMETRI2_ID_APPLICAZIONE, 0))))
      {
        ...
        SQL.Append("values ");
        SQL.Append("( ");
        SQL.Append("  " + IDL.CSql(IMDB.Value(IMDBDef1.TBL_PARAMETRI2, IMDBDef1.FLD_PARAMETRI2_ID_APPLICAZIONE, 0), IDL.FMT_NUM, MainFrm.NotificatoreDBObject.DBO()) + ", ");
        SQL.Append("  " + IDL.CSql(IMDB.Value(IMDBDef1.TBL_PARAMETRI2, IMDBDef1.FLD_PARAMETRI2_DEV_TOKEN, 0), IDL.FMT_CHAR, MainFrm.NotificatoreDBObject.DBO()) + ", ");
        SQL.Append("  " + IDL.CSql(IMDB.Value(IMDBDef1.PQRY_NUOVATABELL1, IMDBDef1.PQSL_NUOVATABELL1_DES_MESSAGGIO, 0), IDL.FMT_CHAR, MainFrm.NotificatoreDBObject.DBO()) + ", ");
        SQL.Append("  'W', ");
        SQL.Append("  GETDATE(), ");
  ...
  // **********************************************************************
  private void INVIWINPMANU_NUOVATABELL1()
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef1.PQRY_NUOVATABELL1_RS);
    IMDB.TblMoveFirst(IMDBDef1.TBL_PARAMETRI2, 0);
    Loop1: while (!IMDB.Eof(IMDBDef1.TBL_PARAMETRI2, 0))
    {
      IMDB.TblAddNew(IMDBDef1.PQRY_NUOVATABELL1_RS, 0);
      IMDB.TblLinkRow(IMDBDef1.PQRY_NUOVATABELL1_RS, 0, IMDBDef1.TBL_PARAMETRI2, 0);
      IMDB.TblLinkField(IMDBDef1.PQRY_NUOVATABELL1_RS, 0, 0, IMDBDef1.TBL_PARAMETRI2, IMDBDef1.FLD_PARAMETRI2_DES_MESSAGGIO, 0);
      IMDB.TblLinkField(IMDBDef1.PQRY_NUOVATABELL1_RS, 1, 0, IMDBDef1.TBL_PARAMETRI2, IMDBDef1.FLD_PARAMETRI2_REG_ID, 0);
      IMDB.TblLinkField(IMDBDef1.PQRY_NUOVATABELL1_RS, 2, 0, IMDBDef1.TBL_PARAMETRI2, IMDBDef1.FLD_PARAMETRI2_RISUNOMEOGGE, 0);
      IMDB.TblMoveNext(IMDBDef1.TBL_PARAMETRI2, 0);
      if (IMDB.Eof(IMDBDef1.TBL_PARAMETRI2, 0))
      {
        IMDB.TblMoveFirst(IMDBDef1.TBL_PARAMETRI2, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef1.PQRY_NUOVATABELL1_RS, 0);
  }
  ...
  private void PAN_PARAMETRI_Init()
  {
    ...
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_RISULTATO, "5FF28491-048C-4E27-8004-5AF649C34FBC");
    ...
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, "6926F802-5416-45E7-8AA6-4416B0F46F65");
    PAN_PARAMETRI.set_Header(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, "RegUrl");
    PAN_PARAMETRI.set_ToolTip(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, "RegID usato da android");
    PAN_PARAMETRI.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.VIS_NORMALFIELDS);
    PAN_PARAMETRI.SetFlags(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISOPT, -1);
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, "8F7A8838-2735-43A9-9733-AF14C6D01DD7");
    ...
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHETINVIA, "77A035C7-1A97-42B6-9857-F3066040EE54");
    ...
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, "4A2E4B4A-9C2C-40A1-A27B-7C2A9E20447A");
  ...
  private void PAN_PARAMETRI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_RISULTATO, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_RISULTATO, PPQRY_NUOVATABELL1, "A.RISUNOMEOGGE", "RISUNOMEOGGE", 9, 5000, 0, -1709);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_LIST, 4, 124, 528, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_LIST, 128);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_LIST, 1);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_LIST, "RegUrl");
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_FORM, 4, 28, 528, 88, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_FORM, 128);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_FORM, 5);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGURL, MyGlb.PANEL_FORM, "RegUrl");
    PAN_PARAMETRI.SetFieldPage(PFL_PARAMETRI_REGURL, -1, -1);
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_REGURL, PPQRY_NUOVATABELL1, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 8);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_MESSAGSPEDIZ, PPQRY_NUOVATABELL1, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHETINVIA, MyGlb.PANEL_FORM, 424, 276, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_ETICHETINVIA, -1, "", "ETICHETINVIA", 0, 0, 0, -1709);
    ...
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, MyGlb.PANEL_LIST, 1);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, MyGlb.PANEL_FORM, 300, 276, 116, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, MyGlb.PANEL_FORM, 0);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, MyGlb.PANEL_FORM, 1);
    PAN_PARAMETRI.SetFieldPage(PFL_PARAMETRI_ETICCREASPED, -1, -1);
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_ETICCREASPED, -1, "", "ETICCREASPED", 0, 0, 0, -1709);
  }
  ...
  private void PAN_PARAMETRI_InitQueries()
  {
    ...
    PAN_PARAMETRI.SetIMDB(IMDB, "PQRY_NUOVATABELL1", true);
    PAN_PARAMETRI.set_SetString(MyGlb.MASTER_ROWNAME, "Nome Oggetto");
    PAN_PARAMETRI.SetQueryIMDB(PPQRY_NUOVATABELL1, IMDBDef1.PQRY_NUOVATABELL1_RS, IMDBDef1.TBL_PARAMETRI2);
    JustLoaded = true;
    PAN_PARAMETRI.SetFieldPrimaryIndex(PFL_PARAMETRI_RISULTATO, IMDBDef1.FLD_PARAMETRI2_RISUNOMEOGGE);
    PAN_PARAMETRI.SetFieldPrimaryIndex(PFL_PARAMETRI_REGURL, IMDBDef1.FLD_PARAMETRI2_REG_ID);
    PAN_PARAMETRI.SetFieldPrimaryIndex(PFL_PARAMETRI_MESSAGSPEDIZ, IMDBDef1.FLD_PARAMETRI2_DES_MESSAGGIO);
    PAN_PARAMETRI.SetMasterTable(0, "PARAMETRI2");
  }
