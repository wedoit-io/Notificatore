...
public partial class InvioWNSManuale : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 636-MyGlb.PAN_OFFS_X, 580-MyGlb.PAN_OFFS_Y, 0, 0);
  ...
  private void PAN_PARAMETRI_InitFields()
  {
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_RISULTATO, MyGlb.PANEL_FORM, 8, 472, 560, 88, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_RISULTATO, PPQRY_NUOVATABELLA, "A.RISUNOMEOGGE", "RISUNOMEOGGE", 9, 5000, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGIDSPEDIZI, MyGlb.PANEL_FORM, 8, 72, 560, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_REGIDSPEDIZI, PPQRY_NUOVATABELLA, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 8, 248, 560, 108, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 108);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 6);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_MESSAGSPEDIZ, PPQRY_NUOVATABELLA, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHETINVIA, MyGlb.PANEL_FORM, 476, 432, 92, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, MyGlb.PANEL_FORM, 448, 364, 116, 36, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSSECRET, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSSECRET, MyGlb.PANEL_FORM, 8, 4, 560, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_WNSSECRET, PPQRY_NUOVATABELLA, "A.WNS_SECRET", "WNS_SECRET", 5, 500, 0, -1709);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSSID, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSSID, MyGlb.PANEL_FORM, 8, 36, 560, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_WNSSID, PPQRY_NUOVATABELLA, "A.WNS_SID", "WNS_SID", 5, 500, 0, -1709);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSXMLTEMPLA, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSXMLTEMPLA, MyGlb.PANEL_FORM, 8, 108, 560, 132, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSXMLTEMPLA, MyGlb.PANEL_FORM, 108);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_WNSXMLTEMPLA, MyGlb.PANEL_FORM, 7);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_WNSXMLTEMPLA, PPQRY_NUOVATABELLA, "A.WNS_XML", "WNS_XML", 9, 5000, 0, -1709);
    ...
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICOTTIACCE, MyGlb.PANEL_LIST, 1);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICOTTIACCE, MyGlb.PANEL_FORM, 120, 364, 136, 36, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_ETICOTTIACCE, -1, "", "ETICOTTIACCE", 0, 0, 0, -1709);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ACCESSTOCKEN, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ACCESSTOCKEN, MyGlb.PANEL_FORM, 8, 412, 444, 52, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_ACCESSTOCKEN, PPQRY_NUOVATABELLA, "A.ACCTOCNOMOGG", "ACCTOCNOMOGG", 9, 5000, 0, -1709);
  }
