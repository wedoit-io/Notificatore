...
public partial class PromoCodes : MyWebForm
{
  ...
  private void PAN_PROMOCODES_InitFields()
  {
    ...
    PAN_PROMOCODES.SetRect(MyGlb.OBJ_FIELD, PFL_PROMOCODES_CODE, MyGlb.PANEL_LIST, 0, 32, 60, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PROMOCODES.SetFieldPanel(PFL_PROMOCODES_CODE, PPQRY_PROMOCODES, "A.CODE", "CODE", 5, 10, 0, -1709);
    PAN_PROMOCODES.SetRect(MyGlb.OBJ_FIELD, PFL_PROMOCODES_DESCRIPRION, MyGlb.PANEL_LIST, 60, 32, 484, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PROMOCODES.SetNumRow(MyGlb.OBJ_FIELD, PFL_PROMOCODES_DESCRIPRION, MyGlb.PANEL_FORM, 1);
    ...
    PAN_PROMOCODES.SetFieldPanel(PFL_PROMOCODES_DESCRIPRION, PPQRY_PROMOCODES, "A.DESCRIPTION", "DESCRIPTION", 5, 200, 0, -1709);
  }
