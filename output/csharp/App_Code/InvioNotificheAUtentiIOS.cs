...
public partial class InvioNotificheAUtentiIOS : MyWebForm
{
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_NOTIFICHE3, 7);
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NOTIFICHE4, 6);
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NOTIFICHE4_RS, 6);
  ...
  private void PAN_NUOVOPANNELL_InitFields()
  {
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_APPLICAZIONE, PPQRY_NOTIFICHE4, "A.IDAPPLINOTIF", "IDAPPLINOTIF", 1, 52, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_UTENTE, PPQRY_NOTIFICHE4, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_SOUND, PPQRY_NOTIFICHE4, "A.SOUND", "SOUND", 5, 200, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_BADGE, PPQRY_NOTIFICHE4, "A.BADGE", "BADGE", 1, 9, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_MESSAGGIO, PPQRY_NOTIFICHE4, "A.MESSAGNOTIFI", "MESSAGNOTIFI", 9, 500, 0, -685);
    ...
    PAN_NUOVOPANNELL.SetFieldPanel(PFL_NUOVOPANNELL_AMBIENTE, PPQRY_NOTIFICHE4, "A.AMBIENNOTIFI", "AMBIENNOTIFI", 5, 1, 0, -685);
  ...
  private void PAN_NUOVOPANNELL_InitQueries()
  {
    ...
    PAN_NUOVOPANNELL.SetQueryDB(PPQRY_APPLICAZIONI, MainFrm.NotificatoreDBObject.DB, 2048);
    SQL = new StringBuilder();
    SQL.Append("select ");
    SQL.Append("  TO_NCHAR ( '[Tutti gli utenti]' ) as TUTTIGLIUTEN ");
    SQL.Append("from ");
    SQL.Append("  dual ");
    SQL.Append("UNION ALL ");
    SQL.Append("select distinct ");
    SQL.Append("  NVL(A.DES_UTENTE, '') ");
    SQL.Append("from ");
    ...
    PAN_NUOVOPANNELL.SetQueryDB(PPQRY_DEVICETOKEN, MainFrm.NotificatoreDBObject.DB, 2048);
