...
public partial class DispositiviNoti : MyWebForm
{
  ...
  private void PAN_DISPOSITNOTI_InitFields()
  {
    ...
    PAN_DISPOSITNOTI.SetRect(MyGlb.OBJ_FIELD, PFL_DISPOSITNOTI_ID, MyGlb.PANEL_LIST, 0, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DISPOSITNOTI.SetFieldPanel(PFL_DISPOSITNOTI_ID, PPQRY_DISPONOTIIOS, "A.ID", "ID", 1, 9, 0, -685);
    PAN_DISPOSITNOTI.SetRect(MyGlb.OBJ_FIELD, PFL_DISPOSITNOTI_NOME, MyGlb.PANEL_LIST, 40, 36, 268, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DISPOSITNOTI.SetFieldPanel(PFL_DISPOSITNOTI_NOME, PPQRY_DISPONOTIIOS, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -685);
    PAN_DISPOSITNOTI.SetRect(MyGlb.OBJ_FIELD, PFL_DISPOSITNOTI_DEVICETOKEN, MyGlb.PANEL_LIST, 308, 36, 296, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DISPOSITNOTI.SetFieldPanel(PFL_DISPOSITNOTI_DEVICETOKEN, PPQRY_DISPONOTIIOS, "A.DEV_TOKEN", "DEV_TOKEN", 5, 1000, 0, -685);
    PAN_DISPOSITNOTI.SetRect(MyGlb.OBJ_FIELD, PFL_DISPOSITNOTI_TYPEOS, MyGlb.PANEL_LIST, 604, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DISPOSITNOTI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DISPOSITNOTI_TYPEOS, MyGlb.PANEL_FORM, "Type OS");
    PAN_DISPOSITNOTI.SetFieldPage(PFL_DISPOSITNOTI_TYPEOS, -1, -1);
    PAN_DISPOSITNOTI.SetFieldPanel(PFL_DISPOSITNOTI_TYPEOS, PPQRY_DISPONOTIIOS, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -685);
  ...
  private void PAN_DISPOSITNOTI_InitQueries()
  {
    ...
    PAN_DISPOSITNOTI.SetQueryDB(PPQRY_DISPONOTIIOS, MainFrm.NotificatoreDBObject.DB, 2048);
    PAN_DISPOSITNOTI.SetMasterTable(0, "DISPOSITIVI_NOTI");
    SQL = new StringBuilder("select DISPOSITIVI_NOTI_ID.NextVal from dual");
