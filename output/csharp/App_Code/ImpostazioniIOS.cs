...
public partial class ImpostazioniIOS : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 788, 492, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_APPSPUSHSETT_InitFields()
  {
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ID, PPQRY_APPLICAZION1, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_APPLICAZIONE, MyGlb.PANEL_LIST, 48, 44, 168, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_APPLICAZIONE, PPQRY_APPLICAZION1, "A.ID_APP", "ID_APP", 1, 9, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_CERTIFICPUSH, MyGlb.PANEL_LIST, 216, 44, 116, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_CERTIFICPUSH, PPQRY_APPLICAZION1, "A.CERT_DEV", "CERT_DEV", 5, 300, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_DATASCADENZA, MyGlb.PANEL_LIST, 332, 44, 120, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_DATASCADENZA, PPQRY_APPLICAZION1, "A.DAT_SCAD_CERT", "DAT_SCAD_CERT", 8, 10, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_NOTA, MyGlb.PANEL_LIST, 452, 44, 112, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_NOTA, PPQRY_APPLICAZION1, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_AMBIENTE, MyGlb.PANEL_LIST, 564, 44, 88, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_AMBIENTE, PPQRY_APPLICAZION1, "A.FLG_AMBIENTE", "FLG_AMBIENTE", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_ATTIVA, MyGlb.PANEL_LIST, 652, 44, 48, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ATTIVA, PPQRY_APPLICAZION1, "A.FLG_ATTIVA", "FLG_ATTIVA", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_TYPEOS, PPQRY_APPLICAZION1, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_ERRORI, MyGlb.PANEL_LIST, 700, 44, 88, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ERRORI, PPQRY_APPLICAZION1, "A.DES_ERR", "DES_ERR", 5, 100, 0, -1709);
  }
  ...
  private void PAN_APPSPUSHSETT_InitQueries()
  {
    ...
    PAN_APPSPUSHSETT.SetQueryDB(PPQRY_APPLICAZION1, MainFrm.NotificatoreDBObject.DB, 256);
