...
public partial class SpedizioniAndroid : MyWebForm
{
  ...
  private const int PFL_SPEDIZIONI_CUSTOMFIELD1 = 17;
  private const int PFL_SPEDIZIONI_CUSTOMFIELD2 = 18;
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_SPEDIZIONI3, 18);
    ...
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI3,IMDBDef1.PQSL_SPEDIZIONI3_CUSTOM_FIELD1, "CUSTOM_FIELD1");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI3,IMDBDef1.PQSL_SPEDIZIONI3_CUSTOM_FIELD1,5,100,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_SPEDIZIONI3,IMDBDef1.PQSL_SPEDIZIONI3_CUSTOM_FIELD2, "CUSTOM_FIELD2");
    IMDB.SetFldParams(IMDBDef1.PQRY_SPEDIZIONI3,IMDBDef1.PQSL_SPEDIZIONI3_CUSTOM_FIELD2,5,100,0);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 1192-MyGlb.PAN_OFFS_X, 844-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "05052C51-D10F-462A-95D1-0DC842B80607");
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 1120, 536, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_SPEDIZIONI_Init()
  {
    ...
    PAN_SPEDIZIONI.SetSize(MyGlb.OBJ_FIELD, 19);
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD1, "FCE4B082-E517-4177-B570-F7F2135D1C79");
    ...
    PAN_SPEDIZIONI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD2, "8A45C62B-B4E8-4338-B96E-D3165D39465D");
  ...
  private void PAN_SPEDIZIONI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_ID, MyGlb.PANEL_LIST, 0, 32, 48, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_ID, PPQRY_SPEDIZIONI3, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_APPLICAZIONE, MyGlb.PANEL_LIST, 48, 32, 88, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_APPLICAZIONE, PPQRY_SPEDIZIONI3, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAINSERIME, MyGlb.PANEL_LIST, 136, 32, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAINSERIME, PPQRY_SPEDIZIONI3, "A.DAT_CREAZ", "DAT_CREAZ", 8, 61, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DATAELABORAZ, MyGlb.PANEL_LIST, 244, 32, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAELABORAZ, PPQRY_SPEDIZIONI3, "A.DAT_ELAB", "DAT_ELAB", 8, 61, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_UTENTE, MyGlb.PANEL_LIST, 352, 32, 124, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_UTENTE, PPQRY_SPEDIZIONI3, "A.DES_UTENTE", "DES_UTENTE", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DISPOSITNOTI, MyGlb.PANEL_LIST, 476, 32, 164, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
  ...
  SQL.Append(")");
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DISPOSITNOTI, PPQRY_SPEDIZIONI3, SQL.ToString(), "DISPNOTISPED", 9, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, MyGlb.PANEL_LIST, 0, 572, 224, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DEVICETOKEN, PPQRY_SPEDIZIONI3, "A.DEV_TOKEN", "DEV_TOKEN", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, 640, 32, 136, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_MESSAGGIO, PPQRY_SPEDIZIONI3, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_LINGUA, MyGlb.PANEL_LIST, 776, 32, 52, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_LINGUA, MyGlb.PANEL_FORM, 1);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_LINGUA, PPQRY_DEVICETOKEN, "B.DES_LINGUA", "DESLINDEVTOK", 5, 150, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, MyGlb.PANEL_LIST, 236, 572, 76, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_BADGE, PPQRY_SPEDIZIONI3, "A.BADGE", "BADGE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, MyGlb.PANEL_LIST, 828, 32, 80, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_STATO, PPQRY_SPEDIZIONI3, "A.FLG_STATO", "FLG_STATO", 5, 1, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_LIST, 908, 32, 32, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_NUMEROTENTAT, PPQRY_SPEDIZIONI3, "A.TENTATIVI", "TENTATIVI", 1, 3, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_SOUND, MyGlb.PANEL_LIST, 324, 572, 196, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_SOUND, PPQRY_SPEDIZIONI3, "A.SOUND", "SOUND", 5, 200, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_LIST, 532, 572, 276, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_GUIDGRUPINVI, PPQRY_SPEDIZIONI3, "A.GUID_GRUPPO", "GUID_GRUPPO", 5, 200, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 0, 608, 432, 120, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    PAN_SPEDIZIONI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 20);
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 5);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_INFO, PPQRY_SPEDIZIONI3, "A.INFO", "INFO", 5, 2000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID, MyGlb.PANEL_LIST, 452, 608, 448, 120, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    PAN_SPEDIZIONI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID, MyGlb.PANEL_LIST, 20);
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID, MyGlb.PANEL_LIST, 5);
    ...
    PAN_SPEDIZIONI.SetNumRow(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID, MyGlb.PANEL_FORM, 1);
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGID, MyGlb.PANEL_FORM, "Reg.");
    PAN_SPEDIZIONI.SetFieldPage(PFL_SPEDIZIONI_REGID, -1, -1);
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_REGID, PPQRY_SPEDIZIONI3, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_TYPEOS, PPQRY_SPEDIZIONI3, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD1, MyGlb.PANEL_LIST, 940, 32, 84, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD1, MyGlb.PANEL_FORM, 4, 496, 592, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_CUSTOMFIELD1, PPQRY_SPEDIZIONI3, "A.CUSTOM_FIELD1", "CUSTOM_FIELD1", 5, 100, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD2, MyGlb.PANEL_LIST, 1024, 32, 96, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD2, MyGlb.PANEL_LIST, "Custom Field 2");
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_CUSTOMFIELD2, MyGlb.PANEL_FORM, 4, 520, 592, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_CUSTOMFIELD2, PPQRY_SPEDIZIONI3, "A.CUSTOM_FIELD2", "CUSTOM_FIELD2", 5, 100, 0, -1709);
  }
  ...
  private void PAN_SPEDIZIONI_InitQueries()
  {
    ...
    PAN_SPEDIZIONI.SetQueryDB(PPQRY_SPEDIZIONI3, MainFrm.NotificatoreDBObject.DB, 256);
