...
public class Notificatore : IDWebService
{
  ...
  [SoapRpcMethodAttribute("http://www.progamma.com/SendPush", RequestNamespace = "http://www.progamma.com", ResponseNamespace = "http://www.progamma.com")]
  ...
  {
    Object[] Res = this.Invoke("SendPush", new Object[] {pAuthKey, pApplicationKey, pMessage, pUserName, pSound, pCustomField1, pCustomField2, pBadge});
    return ((String)Res[0]);
  }

  public IDVariant SendPush_ws (IDVariant AuthKey, IDVariant ApplicationKey, IDVariant Message, IDVariant UserName, IDVariant Sound, IDVariant CustomField1, IDVariant CustomField2, IDVariant Badge)
  {
    return IDVariant.convertObject(SendPush(AuthKey.stringValue(), ApplicationKey.stringValue(), Message.stringValue(), UserName.stringValue(), Sound.stringValue(), CustomField1.stringValue(), CustomField2.stringValue(), Badge.intValue()));
  }
