...
public partial class DeviceIDWinStore : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 1024, 496, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_DEVICETOKEN_InitFields()
  {
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ID, PPQRY_DEVICETOKEN4, "A.ID", "ID", 1, 9, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_APPLICAZIONE, PPQRY_DEVICETOKEN4, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DEVTOKEN, PPQRY_DEVICETOKEN4, "A.DEV_TOKEN", "DEV_TOKEN", 5, 200, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIACCE, PPQRY_DEVICETOKEN4, "A.DATA_ULT_ACCESSO", "DATA_ULT_ACCESSO", 8, 61, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATA, PPQRY_DEVICETOKEN4, "A.DATA_CREAZIONE", "DATA_CREAZIONE", 8, 61, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ATTIVO, PPQRY_DEVICETOKEN4, "A.FLG_ATTIVO", "FLG_ATTIVO", 5, 1, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_UTENTE, PPQRY_DEVICETOKEN4, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -685);
  ...
  SQL.Append(")");
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DISPOSITNOTO, PPQRY_DEVICETOKEN4, SQL.ToString(), "DISNOTDEVTOK", 9, 1000, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_RIMOSSO, PPQRY_DEVICETOKEN4, "A.FLG_RIMOSSO", "FLG_RIMOSSO", 5, 1, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIINVI, PPQRY_DEVICETOKEN4, "A.DAT_ULTIMO_INVIO", "DAT_ULTIMO_INVIO", 8, 19, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_NOTA, PPQRY_DEVICETOKEN4, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATARIMOZION, PPQRY_DEVICETOKEN4, "A.DATA_RIMOZ", "DATA_RIMOZ", 8, 61, 0, -685);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_REGURL, PPQRY_DEVICETOKEN4, "A.REG_ID", "REG_ID", 5, 200, 0, -685);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDLINGUA, MyGlb.PANEL_LIST, 968, 36, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_IDLINGUA, PPQRY_DEVICETOKEN4, "A.PRG_LINGUA", "PRG_LINGUA", 1, 9, 0, -685);
  }
  ...
  private void PAN_DEVICETOKEN_InitQueries()
  {
    ...
    PAN_DEVICETOKEN.SetQueryDB(PPQRY_DEVICETOKEN4, MainFrm.NotificatoreDBObject.DB, 2048);
