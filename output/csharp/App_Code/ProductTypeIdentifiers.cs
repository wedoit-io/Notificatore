...
public partial class ProductTypeIdentifiers : MyWebForm
{
  ...
  private void PAN_PRODTYPEIDEN_InitFields()
  {
    ...
    PAN_PRODTYPEIDEN.SetRect(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_IDENTIFIER, MyGlb.PANEL_LIST, 0, 36, 64, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODTYPEIDEN.SetFieldPanel(PFL_PRODTYPEIDEN_IDENTIFIER, PPQRY_PRODTYPEIDEN, "A.IDENTIFIER", "IDENTIFIER", 5, 20, 0, -685);
    PAN_PRODTYPEIDEN.SetRect(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_DESCRIPTION, MyGlb.PANEL_LIST, 64, 36, 204, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODTYPEIDEN.SetNumRow(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_DESCRIPTION, MyGlb.PANEL_FORM, 2);
    ...
    PAN_PRODTYPEIDEN.SetFieldPanel(PFL_PRODTYPEIDEN_DESCRIPTION, PPQRY_PRODTYPEIDEN, "A.DESCRIPTION", "DESCRIPTION", 5, 200, 0, -685);
    PAN_PRODTYPEIDEN.SetRect(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_FREEAPP, MyGlb.PANEL_LIST, 268, 36, 72, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODTYPEIDEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_FREEAPP, MyGlb.PANEL_FORM, "Free App");
    PAN_PRODTYPEIDEN.SetFieldPage(PFL_PRODTYPEIDEN_FREEAPP, -1, -1);
    PAN_PRODTYPEIDEN.SetFieldPanel(PFL_PRODTYPEIDEN_FREEAPP, PPQRY_PRODTYPEIDEN, "A.FREE_APPS", "FREE_APPS", 1, 2, 0, -685);
    ...
    PAN_PRODTYPEIDEN.SetRect(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_PAIDAPP, MyGlb.PANEL_LIST, 340, 36, 72, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODTYPEIDEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_PAIDAPP, MyGlb.PANEL_FORM, "Paid App");
    PAN_PRODTYPEIDEN.SetFieldPage(PFL_PRODTYPEIDEN_PAIDAPP, -1, -1);
    PAN_PRODTYPEIDEN.SetFieldPanel(PFL_PRODTYPEIDEN_PAIDAPP, PPQRY_PRODTYPEIDEN, "A.PAID_APPS", "PAID_APPS", 1, 2, 0, -685);
    ...
    PAN_PRODTYPEIDEN.SetRect(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_INAPPS, MyGlb.PANEL_LIST, 412, 36, 68, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODTYPEIDEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_INAPPS, MyGlb.PANEL_FORM, "In Apps");
    PAN_PRODTYPEIDEN.SetFieldPage(PFL_PRODTYPEIDEN_INAPPS, -1, -1);
    PAN_PRODTYPEIDEN.SetFieldPanel(PFL_PRODTYPEIDEN_INAPPS, PPQRY_PRODTYPEIDEN, "A.IN_APPS", "IN_APPS", 1, 2, 0, -685);
    ...
    PAN_PRODTYPEIDEN.SetRect(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_UPDATE, MyGlb.PANEL_LIST, 480, 36, 64, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODTYPEIDEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PRODTYPEIDEN_UPDATE, MyGlb.PANEL_FORM, "Update");
    PAN_PRODTYPEIDEN.SetFieldPage(PFL_PRODTYPEIDEN_UPDATE, -1, -1);
    PAN_PRODTYPEIDEN.SetFieldPanel(PFL_PRODTYPEIDEN_UPDATE, PPQRY_PRODTYPEIDEN, "A.UPDATE_APPS", "UPDATE_APPS", 1, 2, 0, -685);
  ...
  private void PAN_PRODTYPEIDEN_InitQueries()
  {
    ...
    PAN_PRODTYPEIDEN.SetQueryDB(PPQRY_PRODTYPEIDEN, MainFrm.NotificatoreDBObject.DB, 2048);
