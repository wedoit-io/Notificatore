...
public partial class ImpostazioniWinPhone : MyWebForm
{
  ...
  private void PAN_APPSPUSHSETT_InitFields()
  {
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ID, PPQRY_APPLICAZIONI, "A.ID", "ID", 1, 9, 0, -685);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_APPLICAZIONE, PPQRY_APPLICAZIONI, "A.ID_APP", "ID_APP", 1, 9, 0, -685);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_ATTIVA, MyGlb.PANEL_LIST, 216, 48, 52, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ATTIVA, PPQRY_APPLICAZIONI, "A.FLG_ATTIVA", "FLG_ATTIVA", 5, 1, 0, -685);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_AMBIENTE, MyGlb.PANEL_LIST, 268, 48, 88, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_AMBIENTE, PPQRY_APPLICAZIONI, "A.FLG_AMBIENTE", "FLG_AMBIENTE", 5, 1, 0, -685);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_NOTA, MyGlb.PANEL_LIST, 356, 48, 284, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_NOTA, PPQRY_APPLICAZIONI, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -685);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSXMLTEMPLA, MyGlb.PANEL_LIST, 0, 416, 640, 236, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_APPSPUSHSETT.SetNumRow(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSXMLTEMPLA, MyGlb.PANEL_FORM, 24);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_WNSXMLTEMPLA, PPQRY_APPLICAZIONI, "A.WNS_XML", "WNS_XML", 9, 5000, 0, -685);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_TYPEOS, PPQRY_APPLICAZIONI, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -685);
