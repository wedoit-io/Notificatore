...
public partial class DeviceIDAndroid : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 1124-MyGlb.PAN_OFFS_X, 652-MyGlb.PAN_OFFS_Y, 0, 0);
  ...
  private void PAN_DEVICETOKEN_InitFields()
  {
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ID, PPQRY_DEVICETOKEN3, "A.ID", "ID", 1, 9, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_APPLICAZIONE, PPQRY_DEVICETOKEN3, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DEVTOKEN, MyGlb.PANEL_LIST, 116, 32, 120, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DEVTOKEN, PPQRY_DEVICETOKEN3, "A.DEV_TOKEN", "DEV_TOKEN", 5, 200, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATAULTIACCE, MyGlb.PANEL_LIST, 236, 32, 108, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIACCE, PPQRY_DEVICETOKEN3, "A.DATA_ULT_ACCESSO", "DATA_ULT_ACCESSO", 8, 61, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATA, MyGlb.PANEL_LIST, 344, 32, 104, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATA, PPQRY_DEVICETOKEN3, "A.DATA_CREAZIONE", "DATA_CREAZIONE", 8, 61, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ATTIVO, MyGlb.PANEL_LIST, 448, 32, 48, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ATTIVO, PPQRY_DEVICETOKEN3, "A.FLG_ATTIVO", "FLG_ATTIVO", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_UTENTE, MyGlb.PANEL_LIST, 496, 32, 88, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_UTENTE, PPQRY_DEVICETOKEN3, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DISPOSITNOTO, MyGlb.PANEL_LIST, 584, 32, 128, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
  ...
  SQL.Append(")");
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DISPOSITNOTO, PPQRY_DEVICETOKEN3, SQL.ToString(), "DISNOTDEVTOK", 9, 1000, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_LINGUA, MyGlb.PANEL_LIST, 712, 32, 68, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_LINGUA, PPQRY_DEVICETOKEN3, "A.PRG_LINGUA", "PRG_LINGUA", 1, 9, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_RIMOSSO, MyGlb.PANEL_LIST, 780, 32, 44, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_RIMOSSO, PPQRY_DEVICETOKEN3, "A.FLG_RIMOSSO", "FLG_RIMOSSO", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATAULTIINVI, MyGlb.PANEL_LIST, 824, 32, 120, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIINVI, PPQRY_DEVICETOKEN3, "A.DAT_ULTIMO_INVIO", "DAT_ULTIMO_INVIO", 8, 19, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATARIMOZION, MyGlb.PANEL_LIST, 944, 32, 96, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATARIMOZION, PPQRY_DEVICETOKEN3, "A.DATA_RIMOZ", "DATA_RIMOZ", 8, 61, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_NOTA, MyGlb.PANEL_LIST, 532, 508, 432, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_NOTA, PPQRY_DEVICETOKEN3, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_CUSTOMTAG, MyGlb.PANEL_LIST, 532, 544, 432, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_CUSTOMTAG, MyGlb.PANEL_LIST, "Cust. TAG");
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_CUSTOMTAG, PPQRY_DEVICETOKEN3, "A.CUSTOM_TAG", "CUSTOM_TAG", 5, 200, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_REGID, MyGlb.PANEL_LIST, 0, 512, 520, 68, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_REGID, PPQRY_DEVICETOKEN3, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
  }
  ...
  private void PAN_DEVICETOKEN_InitQueries()
  {
    ...
    PAN_DEVICETOKEN.SetQueryDB(PPQRY_DEVICETOKEN3, MainFrm.NotificatoreDBObject.DB, 256);
