...
public partial class DeviceToken : MyWebForm
{
  ...
  private void PAN_DEVICETOKEN_InitFields()
  {
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ID, PPQRY_DEVICETOKEN, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDAPPSPUSSET, MyGlb.PANEL_LIST, 40, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDAPPSPUSSET, MyGlb.PANEL_LIST, "I. A. P. S.");
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_IDAPPSPUSSET, PPQRY_DEVICETOKEN, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_NOTAPPPUSSET, MyGlb.PANEL_LIST, "Nt. App. Psh. Sett.");
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_NOTAPPPUSSET, MyGlb.PANEL_FORM, "Nt. Ap. Ps. Stt.");
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_NOTAPPPUSSET, -1, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_NOTAPPPUSSET, PPQRY_LOOAPPPUSSET, "A.DES_NOTA", "NOAPPUSENOOG", 5, 100, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DEVTOKEN, PPQRY_DEVICETOKEN, "A.DEV_TOKEN", "DEV_TOKEN", 5, 200, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATAULTIACCE, MyGlb.PANEL_FORM, "Dt. Ult. Acc.");
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_DATAULTIACCE, -1, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIACCE, PPQRY_DEVICETOKEN, "A.DATA_ULT_ACCESSO", "DATA_ULT_ACCESSO", 8, 61, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATA, PPQRY_DEVICETOKEN, "A.DATA_CREAZIONE", "DATA_CREAZIONE", 8, 61, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_ATTIVO, MyGlb.PANEL_LIST, 80, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_ATTIVO, PPQRY_DEVICETOKEN, "A.FLG_ATTIVO", "FLG_ATTIVO", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_UTENTE, PPQRY_DEVICETOKEN, "A.DES_UTENTE", "DES_UTENTE", 5, 100, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_RIMOSSO, MyGlb.PANEL_LIST, 136, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_RIMOSSO, PPQRY_DEVICETOKEN, "A.FLG_RIMOSSO", "FLG_RIMOSSO", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DATAULTIINVI, MyGlb.PANEL_LIST, 192, 32, 160, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATAULTIINVI, PPQRY_DEVICETOKEN, "A.DAT_ULTIMO_INVIO", "DAT_ULTIMO_INVIO", 8, 19, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_NOTA, PPQRY_DEVICETOKEN, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATARIMOZION, PPQRY_DEVICETOKEN, "A.DATA_RIMOZ", "DATA_RIMOZ", 8, 61, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_REGID, PPQRY_DEVICETOKEN, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_CUSTOMTAG, PPQRY_DEVICETOKEN, "A.CUSTOM_TAG", "CUSTOM_TAG", 5, 200, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_TYPEOS, MyGlb.PANEL_LIST, 352, 32, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_TYPEOS, PPQRY_DEVICETOKEN, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DATACUPERTIN, PPQRY_DEVICETOKEN, "A.DATA_CUPERTINO", "DATA_CUPERTINO", 8, 61, 0, -1709);
    PAN_DEVICETOKEN.SetRect(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_IDLINGUA, MyGlb.PANEL_LIST, 456, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_IDLINGUA, PPQRY_DEVICETOKEN, "A.PRG_LINGUA", "PRG_LINGUA", 1, 9, 0, -1709);
    ...
    PAN_DEVICETOKEN.SetNumRow(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DESCRILINGUA, MyGlb.PANEL_LIST, 1);
    ...
    PAN_DEVICETOKEN.SetNumRow(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DESCRILINGUA, MyGlb.PANEL_FORM, 1);
    PAN_DEVICETOKEN.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_DEVICETOKEN_DESCRILINGUA, MyGlb.PANEL_FORM, "Descr. Lingua");
    PAN_DEVICETOKEN.SetFieldPage(PFL_DEVICETOKEN_DESCRILINGUA, -1, -1);
    PAN_DEVICETOKEN.SetFieldPanel(PFL_DEVICETOKEN_DESCRILINGUA, PPQRY_LOOKUPLINGUA, "A.DES_LINGUA", "DESLINNOMOGG", 5, 150, 0, -1709);
  }
