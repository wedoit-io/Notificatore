...
public partial class Configurazione : MyWebForm
{
  ...
  private void PAN_IMPOSTAZIONI_Init()
  {
    ...
    PAN_IMPOSTAZIONI.SetHeaderSize(MyGlb.OBJ_GROUP, GRP_IMPOSTAZIONI_ANDROID, 1, 15);
  ...
  private void PAN_IMPOSTAZIONI_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_ID, MyGlb.PANEL_LIST, 0, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_ID, PPQRY_IMPOSTAZIONI, "A.ID", "ID", 1, 9, 0, -1709);
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_URLDIBASEAPP, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_URLDIBASEAPP, PPQRY_IMPOSTAZIONI, "A.URL_APP", "URL_APP", 5, 1000, 0, -1709);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_WEBSERVIREFE, PPQRY_IMPOSTAZIONI, "A.WS_URL", "WS_URL", 5, 1000, 0, -1709);
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_ATAUDEDAOG4S, MyGlb.PANEL_LIST, 40, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_ATAUDEDAOG4S, PPQRY_IMPOSTAZIONI, "A.FLG_REFRESH", "FLG_REFRESH", 5, 1, 0, -1709);
    ...
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_GIDIREPELACM, MyGlb.PANEL_LIST, 0, 32, 88, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_BOTTINVINOTI, -1, "", "BOTTINVINOTI", 0, 0, 0, -1709);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_BOTRIPSPEINV, -1, "", "BOTRIPSPEINV", 0, 0, 0, -1709);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_BOTTRIPUSPED, -1, "", "BOTTRIPUSPED", 0, 0, 0, -1709);
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_IMILLIDITVTL, MyGlb.PANEL_LIST, 0, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetValueListItem(PFL_IMPOSTAZIONI_IMILLIDITVTL, (new IDVariant(1)), "Livello 1 - Errori", "", "", -1);
    PAN_IMPOSTAZIONI.SetValueListItem(PFL_IMPOSTAZIONI_IMILLIDITVTL, (new IDVariant(2)), "Livello 2 - Trace", "", "", -1);
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_PERCERNOTPUS, MyGlb.PANEL_LIST, 0, 32, 432, 44, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_PERCERNOTPUS, PPQRY_IMPOSTAZIONI, "A.PATH_CERTS", "PATH_CERTS", 5, 1000, 0, -1709);
    PAN_IMPOSTAZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_ATAUFEOG60MI, MyGlb.PANEL_LIST, 0, 32, 140, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_BOTTCHECFEED, -1, "", "BOTTCHECFEED", 0, 0, 0, -1709);
    ...
    PAN_IMPOSTAZIONI.SetFieldPanel(PFL_IMPOSTAZIONI_BOTELMAITORI, -1, "", "BOTELMAITORI", 0, 0, 0, -1709);
    ...
    PAN_IMPOSTAZIONI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_IMPOSTAZIONI_MAXMESMEPESP, MyGlb.PANEL_LIST, "M. M. Ms. p. sp.");
