...
public partial class Logs : MyWebForm
{
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_MESSAGGI, 4);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_LOGS.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 844, 372, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_LOGS_Init()
  {
    ...
    PAN_LOGS.SetSize(MyGlb.OBJ_FIELD, 4);
    ...
    PAN_LOGS.SetFlags(MyGlb.OBJ_FIELD, PFL_LOGS_LIVELLO, 0 | MyGlb.FLD_ISOPT, -1);
  }
  ...
  private void PAN_LOGS_InitFields()
  {
    ...
    StringBuilder SQL = new StringBuilder();
    PAN_LOGS.SetRect(MyGlb.OBJ_FIELD, PFL_LOGS_ID, MyGlb.PANEL_LIST, 232, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_LOGS.SetFieldPanel(PFL_LOGS_ID, PPQRY_MESSAGGI, "A.ID", "ID", 1, 9, 0, -685);
    PAN_LOGS.SetRect(MyGlb.OBJ_FIELD, PFL_LOGS_DATA, MyGlb.PANEL_LIST, 0, 36, 104, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_LOGS.SetFieldPanel(PFL_LOGS_DATA, PPQRY_MESSAGGI, "A.DATA_LOG", "DATA_LOG", 8, 61, 0, -685);
    PAN_LOGS.SetRect(MyGlb.OBJ_FIELD, PFL_LOGS_TESTO, MyGlb.PANEL_LIST, 104, 36, 740, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_LOGS.SetFieldPanel(PFL_LOGS_TESTO, PPQRY_MESSAGGI, "A.TESTO", "TESTO", 9, 10000, 0, -685);
    PAN_LOGS.SetRect(MyGlb.OBJ_FIELD, PFL_LOGS_LIVELLO, MyGlb.PANEL_LIST, 764, 36, 68, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_LOGS.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_LOGS_LIVELLO, MyGlb.PANEL_FORM, "Livello");
    PAN_LOGS.SetFieldPage(PFL_LOGS_LIVELLO, -1, -1);
    PAN_LOGS.SetFieldPanel(PFL_LOGS_LIVELLO, PPQRY_MESSAGGI, "A.FLG_LEV_DEBUG", "FLG_LEV_DEBUG", 1, 9, 0, -685);
    PAN_LOGS.SetValueListItem(PFL_LOGS_LIVELLO, (new IDVariant(0)), "Spento", "", "", -1);
    PAN_LOGS.SetValueListItem(PFL_LOGS_LIVELLO, (new IDVariant(1)), "Acceso", "", "", -1);
  }
  ...
  private void PAN_LOGS_InitQueries()
  {
    ...
    PAN_LOGS.SetQueryDB(PPQRY_MESSAGGI, MainFrm.NotificatoreDBObject.DB, 2048);
    PAN_LOGS.SetMasterTable(0, "LOGS");
    PAN_LOGS.AddToSortList(PFL_LOGS_DATA, false);
    SQL = new StringBuilder("select LOGS_ID.NextVal from dual");
