...
public partial class SpedizioniWinPhone : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 944, 480, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_SPEDIZIONI_InitFields()
  {
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_ID, PPQRY_SPEDIZIONI2, "A.ID", "ID", 1, 9, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_APPLICAZIONE, PPQRY_SPEDIZIONI2, "A.ID_APPLICAZIONE", "ID_APPLICAZIONE", 1, 9, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAINSERIME, PPQRY_SPEDIZIONI2, "A.DAT_CREAZ", "DAT_CREAZ", 8, 61, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DATAELABORAZ, PPQRY_SPEDIZIONI2, "A.DAT_ELAB", "DAT_ELAB", 8, 61, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_UTENTE, MyGlb.PANEL_LIST, 360, 32, 144, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_UTENTE, PPQRY_SPEDIZIONI2, "A.DES_UTENTE", "DES_UTENTE", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DISPOSITNOTI, MyGlb.PANEL_LIST, 504, 32, 176, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
  ...
  SQL.Append(")");
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DISPOSITNOTI, PPQRY_SPEDIZIONI2, SQL.ToString(), "DISPNOTISPED", 9, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_GUIDGRUPINVI, MyGlb.PANEL_LIST, 680, 32, 120, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_GUIDGRUPINVI, PPQRY_SPEDIZIONI2, "A.GUID_GRUPPO", "GUID_GRUPPO", 5, 200, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_DEVICETOKEN, MyGlb.PANEL_LIST, 440, 512, 504, 28, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_DEVICETOKEN, PPQRY_SPEDIZIONI2, "A.DEV_TOKEN", "DEV_TOKEN", 5, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_MESSAGGIO, MyGlb.PANEL_LIST, 0, 512, 420, 200, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_MESSAGGIO, PPQRY_SPEDIZIONI2, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_BADGE, MyGlb.PANEL_LIST, 800, 32, 32, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_BADGE, PPQRY_SPEDIZIONI2, "A.BADGE", "BADGE", 1, 9, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_STATO, MyGlb.PANEL_LIST, 832, 32, 80, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_STATO, PPQRY_SPEDIZIONI2, "A.FLG_STATO", "FLG_STATO", 5, 1, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_NUMEROTENTAT, MyGlb.PANEL_LIST, 912, 32, 32, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_NUMEROTENTAT, PPQRY_SPEDIZIONI2, "A.TENTATIVI", "TENTATIVI", 1, 3, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_INFO, MyGlb.PANEL_LIST, 440, 624, 500, 88, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_INFO, PPQRY_SPEDIZIONI2, "A.INFO", "INFO", 5, 2000, 0, -1709);
    PAN_SPEDIZIONI.SetRect(MyGlb.OBJ_FIELD, PFL_SPEDIZIONI_REGURL, MyGlb.PANEL_LIST, 440, 544, 504, 80, MyGlb.RESMODE_MOVE, MyGlb.RESMODE_MOVE);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_REGURL, PPQRY_SPEDIZIONI2, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_SPEDIZIONI.SetFieldPanel(PFL_SPEDIZIONI_TYPEOS, PPQRY_SPEDIZIONI2, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
