...
[Serializable]
public partial class CountryCodes : MyWebForm
{
  internal MyWebEntryPoint MainFrm;

  // Frame constant definitions
  private const int PFL_COUNTRYCODES_CODE = 0;
  private const int PFL_COUNTRYCODES_DESCRIPRION = 1;

  private const int PPQRY_COUNTRYCODES = 0;


  internal IDPanel PAN_COUNTRYCODES;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    //
    //
    Init_PQRY_COUNTRYCODES(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_PQRY_COUNTRYCODES(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_COUNTRYCODES, 2);
    IMDB.set_TblCode(IMDBDef1.PQRY_COUNTRYCODES, "PQRY_COUNTRYCODES");
    IMDB.set_FldCode(IMDBDef1.PQRY_COUNTRYCODES,IMDBDef1.PQSL_COUNTRYCODES_CODE, "CODE");
    IMDB.SetFldParams(IMDBDef1.PQRY_COUNTRYCODES,IMDBDef1.PQSL_COUNTRYCODES_CODE,5,3,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_COUNTRYCODES,IMDBDef1.PQSL_COUNTRYCODES_DESCRIPTION, "DESCRIPTION");
    IMDB.SetFldParams(IMDBDef1.PQRY_COUNTRYCODES,IMDBDef1.PQSL_COUNTRYCODES_DESCRIPTION,5,200,0);
    IMDB.TblAddNew(IMDBDef1.PQRY_COUNTRYCODES, 0);
  }
  ...
  // **********************************************
  public CountryCodes(MyWebEntryPoint w, IMDBObj imdb)
    : base()
  {
    //
    SetMainFrm(w, imdb);
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_COUNTRYCODES;
    //
    if (flMulti)
      MainFrm.AddMultipleForm(this, flSubForm);
    //
    //
    RTCGuid = "88439FC6-7C12-42B8-B1E0-96AD1DDDFC68";
    ResModeW = 3;
    ResModeH = 3;
    iVisualFlags = -2049;
    DesignWidth = 604;
    DesignHeight = 576;
    set_Caption(new IDVariant("Country Codes"));
    //
    Frames = new AFrame[2];
    ...
    Frames[1].Width = 604;
    Frames[1].Height = 516;
    Frames[1].Caption = "Country Codes";
    Frames[1].Parent = this;
    Frames[1].FixedHeight = 516;
    PAN_COUNTRYCODES = new IDPanel(w, this, 1, "PAN_COUNTRYCODES");
    Frames[1].Content = PAN_COUNTRYCODES;
    PAN_COUNTRYCODES.set_VisualFlag(Glb.PANVISPROP_HILITEROW,true);
    PAN_COUNTRYCODES.VS = MainFrm.VisualStyleList;
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 604-MyGlb.PAN_OFFS_X, 516-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_COUNTRYCODES.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "DADE03AE-1F00-41D1-8B34-FD160AF2039F");
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 544, 456, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
    PAN_COUNTRYCODES.set_VisualStyle(MyGlb.OBJ_PANEL, 0, MyGlb.VIS_DEFAPANESTYL);
    PAN_COUNTRYCODES.SetHeaderSize(MyGlb.OBJ_PANEL, 0, 0, 32);
    PAN_COUNTRYCODES.SetFlags(MyGlb.OBJ_PANEL, 0, MainFrm.GlbPanelFlags | MyGlb.PAN_SCROLLREC | MyGlb.PAN_HASLIST | MyGlb.PAN_CANDELETE | MyGlb.PAN_CANUPDATE | MyGlb.PAN_CANSELECT | MyGlb.PAN_CANINSERT | MyGlb.OBJ_VISIBLE | MyGlb.OBJ_ENABLED, -1);
    PAN_COUNTRYCODES.InitStatus = 2;
    PAN_COUNTRYCODES_Init();
    PAN_COUNTRYCODES_InitFields();
    PAN_COUNTRYCODES_InitQueries();
    HelpFile = "";
    //
  ...
  public override void UpdateControls()
  {
    try
    {
      PAN_COUNTRYCODES.UpdatePanel(MainFrm);
      //
    }
    catch (Exception e)
    {
  ...
  {
    return (FullName ? typeof(CountryCodes).FullName : typeof(CountryCodes).Name);
  }
  ...
  // Frame Events
  // **********************************************
  private void PAN_COUNTRYCODES_CellActivated(IDVariant ColIndex, IDVariant Cancel)
  {
    int i = 0;
  }

  private void PAN_COUNTRYCODES_ValidateCell(IDVariant ColIndex, IDVariant CellModified, IDVariant Cancel, IDVariant FldWasModified, IDVariant RowWasModified, IDVariant IsInsert)
  {
    try
    {
    }
  ...
  private void PAN_COUNTRYCODES_ValidateRow(IDVariant Cancel)
  {
    try
    {
    } catch ( Exception e) { }
  ...
  // **********************************************
  private void PAN_COUNTRYCODES_Init()
  {

    PAN_COUNTRYCODES.SetSize(MyGlb.OBJ_PAGE, 0);
    PAN_COUNTRYCODES.SetSize(MyGlb.OBJ_GROUP, 0);
    PAN_COUNTRYCODES.SetSize(MyGlb.OBJ_FIELD, 2);
    PAN_COUNTRYCODES.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, "56410FFC-D835-4382-A0BA-0789C832A846");
    PAN_COUNTRYCODES.set_Header(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, "Code");
    PAN_COUNTRYCODES.set_ToolTip(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, "Dashboard type identifier");
    PAN_COUNTRYCODES.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.VIS_PRIMAKEYFIEL);
    PAN_COUNTRYCODES.SetFlags(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISKEY, -1);
    PAN_COUNTRYCODES.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, "1201C2BB-290F-4DC8-904C-4581804CD0E6");
    PAN_COUNTRYCODES.set_Header(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, "Descriprion");
    PAN_COUNTRYCODES.set_ToolTip(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, "Country name");
    PAN_COUNTRYCODES.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.VIS_NORMALFIELDS);
    PAN_COUNTRYCODES.SetFlags(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISDESCR, -1);
  }

  private void PAN_COUNTRYCODES_InitFields()
  {

    StringBuilder SQL = new StringBuilder();
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_LIST, 0, 32, 60, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_COUNTRYCODES.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_LIST, 36);
    PAN_COUNTRYCODES.SetNumRow(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_LIST, 1);
    PAN_COUNTRYCODES.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_LIST, "Code");
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_FORM, 4, 4, 128, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_COUNTRYCODES.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_FORM, 80);
    PAN_COUNTRYCODES.SetNumRow(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_FORM, 1);
    PAN_COUNTRYCODES.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_FORM, "Code");
    PAN_COUNTRYCODES.SetFieldPage(PFL_COUNTRYCODES_CODE, -1, -1);
    PAN_COUNTRYCODES.SetFieldPanel(PFL_COUNTRYCODES_CODE, PPQRY_COUNTRYCODES, "A.CODE", "CODE", 5, 3, 0, -1709);
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_LIST, 60, 32, 484, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    PAN_COUNTRYCODES.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_LIST, 64);
    PAN_COUNTRYCODES.SetNumRow(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_LIST, 1);
    PAN_COUNTRYCODES.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_LIST, "Descriprion");
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_FORM, 4, 28, 480, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_COUNTRYCODES.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_FORM, 80);
    PAN_COUNTRYCODES.SetNumRow(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_FORM, 1);
    PAN_COUNTRYCODES.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_FORM, "Descriprion");
    PAN_COUNTRYCODES.SetFieldPage(PFL_COUNTRYCODES_DESCRIPRION, -1, -1);
    PAN_COUNTRYCODES.SetFieldPanel(PFL_COUNTRYCODES_DESCRIPRION, PPQRY_COUNTRYCODES, "A.DESCRIPTION", "DESCRIPTION", 5, 200, 0, -1709);
  }

  private void PAN_COUNTRYCODES_InitQueries()
  {
    StringBuilder SQL;

    PAN_COUNTRYCODES.SetSize(MyGlb.OBJ_QUERY, 1);
    PAN_COUNTRYCODES.SetIMDB(IMDB, "PQRY_COUNTRYCODES", true);
    PAN_COUNTRYCODES.set_SetString(MyGlb.MASTER_ROWNAME, "Country Code");
    ...
    PAN_COUNTRYCODES.SetQuery(PPQRY_COUNTRYCODES, 1, SQL, -1, "");
    SQL = new StringBuilder();
    PAN_COUNTRYCODES.SetQuery(PPQRY_COUNTRYCODES, 2, SQL, -1, "");
    SQL = new StringBuilder();
    PAN_COUNTRYCODES.SetQuery(PPQRY_COUNTRYCODES, 3, SQL, -1, "");
    SQL = new StringBuilder();
    PAN_COUNTRYCODES.SetQuery(PPQRY_COUNTRYCODES, 4, SQL, -1, "");
    SQL = new StringBuilder();
    PAN_COUNTRYCODES.SetQuery(PPQRY_COUNTRYCODES, 5, SQL, -1, "");
    PAN_COUNTRYCODES.SetQueryDB(PPQRY_COUNTRYCODES, MainFrm.NotificatoreDBObject.DB, 256);
    PAN_COUNTRYCODES.SetMasterTable(0, "APPLE_COUNTRY_CODE");
  }
  ...
  {
    if (SrcObj == PAN_COUNTRYCODES) PAN_COUNTRYCODES_ValidateCell(ColIndex, CellModified , Cancel, FldWasModified, RowWasModified, IsInsert);
  }

  public override void ValidateRow(IDPanel SrcObj, IDVariant Cancel)
  {
    if (SrcObj == PAN_COUNTRYCODES) PAN_COUNTRYCODES_ValidateRow(Cancel);
  }
  ...
  {
    if (SrcObj == PAN_COUNTRYCODES) PAN_COUNTRYCODES_CellActivated(ColIndex, Cancel);
  }
