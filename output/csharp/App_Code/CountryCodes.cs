...
public partial class CountryCodes : MyWebForm
{
  ...
  private void PAN_COUNTRYCODES_InitFields()
  {
    ...
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_CODE, MyGlb.PANEL_LIST, 0, 36, 60, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_COUNTRYCODES.SetFieldPanel(PFL_COUNTRYCODES_CODE, PPQRY_COUNTRYCODES, "A.CODE", "CODE", 5, 3, 0, -685);
    PAN_COUNTRYCODES.SetRect(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_LIST, 60, 36, 484, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_COUNTRYCODES.SetNumRow(MyGlb.OBJ_FIELD, PFL_COUNTRYCODES_DESCRIPRION, MyGlb.PANEL_FORM, 2);
    ...
    PAN_COUNTRYCODES.SetFieldPanel(PFL_COUNTRYCODES_DESCRIPRION, PPQRY_COUNTRYCODES, "A.DESCRIPTION", "DESCRIPTION", 5, 200, 0, -685);
  }
  ...
  private void PAN_COUNTRYCODES_InitQueries()
  {
    ...
    PAN_COUNTRYCODES.SetQueryDB(PPQRY_COUNTRYCODES, MainFrm.NotificatoreDBObject.DB, 2048);
