...
public partial class ImpostazioniWinStore : MyWebForm
{
  ...
  private void PAN_APPSPUSHSETT_Init()
  {
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_WNSACCOUNT, MyGlb.PANEL_LIST, 216, -9999, 492, 22, 0, 0);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_WNSACCOUNT, MyGlb.PANEL_FORM, 0, 140, 548, 100, 0, 0);
    PAN_APPSPUSHSETT.SetHeaderSize(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_WNSACCOUNT, 0, 75);
    PAN_APPSPUSHSETT.SetHeaderSize(MyGlb.OBJ_GROUP, GRP_APPSPUSHSETT_WNSACCOUNT, 1, 15);
  ...
  private void PAN_APPSPUSHSETT_InitFields()
  {
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ID, PPQRY_APPLICAZION4, "A.ID", "ID", 1, 9, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_APPLICAZIONE, PPQRY_APPLICAZION4, "A.ID_APP", "ID_APP", 1, 9, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSSECRET, MyGlb.PANEL_LIST, 216, 44, 248, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_WNSSECRET, PPQRY_APPLICAZION4, "A.WNS_SECRET", "WNS_SECRET", 5, 500, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSPACSECIDE, MyGlb.PANEL_LIST, 464, 44, 244, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSPACSECIDE, MyGlb.PANEL_FORM, "Wns Pack. Secur. Identifier");
    PAN_APPSPUSHSETT.SetFieldPage(PFL_APPSPUSHSETT_WNSPACSECIDE, -1, GRP_APPSPUSHSETT_WNSACCOUNT);
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_WNSPACSECIDE, PPQRY_APPLICAZION4, "A.WNS_SID", "WNS_SID", 5, 500, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_ATTIVA, MyGlb.PANEL_LIST, 708, 44, 52, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_ATTIVA, PPQRY_APPLICAZION4, "A.FLG_ATTIVA", "FLG_ATTIVA", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_AMBIENTE, MyGlb.PANEL_LIST, 760, 44, 56, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_AMBIENTE, PPQRY_APPLICAZION4, "A.FLG_AMBIENTE", "FLG_AMBIENTE", 5, 1, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_NOTA, MyGlb.PANEL_LIST, 816, 44, 168, 28, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_NOTA, PPQRY_APPLICAZION4, "A.DES_NOTA", "DES_NOTA", 5, 100, 0, -1709);
    PAN_APPSPUSHSETT.SetRect(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSXMLTEMPLA, MyGlb.PANEL_LIST, 0, 416, 432, 244, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_MOVE);
    ...
    PAN_APPSPUSHSETT.SetNumRow(MyGlb.OBJ_FIELD, PFL_APPSPUSHSETT_WNSXMLTEMPLA, MyGlb.PANEL_FORM, 14);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_WNSXMLTEMPLA, PPQRY_APPLICAZION4, "A.WNS_XML", "WNS_XML", 9, 5000, 0, -1709);
    ...
    PAN_APPSPUSHSETT.SetFieldPanel(PFL_APPSPUSHSETT_TYPEOS, PPQRY_APPLICAZION4, "A.TYPE_OS", "TYPE_OS", 5, 1, 0, -1709);
