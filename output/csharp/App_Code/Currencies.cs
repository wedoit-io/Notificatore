...
public partial class Currencies : MyWebForm
{
  ...
  private void PAN_CURRENCIES_InitFields()
  {
    ...
    PAN_CURRENCIES.SetRect(MyGlb.OBJ_FIELD, PFL_CURRENCIES_CODE, MyGlb.PANEL_LIST, 0, 36, 60, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_CURRENCIES.SetFieldPanel(PFL_CURRENCIES_CODE, PPQRY_CURRENCIES, "A.CODE", "CODE", 5, 3, 0, -685);
    PAN_CURRENCIES.SetRect(MyGlb.OBJ_FIELD, PFL_CURRENCIES_DESCRIPRION, MyGlb.PANEL_LIST, 60, 36, 484, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_CURRENCIES.SetNumRow(MyGlb.OBJ_FIELD, PFL_CURRENCIES_DESCRIPRION, MyGlb.PANEL_FORM, 2);
    ...
    PAN_CURRENCIES.SetFieldPanel(PFL_CURRENCIES_DESCRIPRION, PPQRY_CURRENCIES, "A.DESCRIPTION", "DESCRIPTION", 5, 200, 0, -685);
  }
  ...
  private void PAN_CURRENCIES_InitQueries()
  {
    ...
    PAN_CURRENCIES.SetQueryDB(PPQRY_CURRENCIES, MainFrm.NotificatoreDBObject.DB, 2048);
