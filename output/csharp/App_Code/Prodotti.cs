...
public partial class Prodotti : MyWebForm
{
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_PRODOTTI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 852-MyGlb.PAN_OFFS_X, 472-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_PRODOTTI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "CA0C05AE-E84C-42E8-8A08-1A9CFCD39A43");
    PAN_PRODOTTI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 324, 416, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  private void PAN_PRODOTTI_InitFields()
  {
    ...
    PAN_PRODOTTI.SetRect(MyGlb.OBJ_FIELD, PFL_PRODOTTI_ID, MyGlb.PANEL_LIST, 0, 36, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODOTTI.SetFieldPanel(PFL_PRODOTTI_ID, PPQRY_PRODOTTI, "A.ID", "ID", 1, 9, 0, -685);
    PAN_PRODOTTI.SetRect(MyGlb.OBJ_FIELD, PFL_PRODOTTI_NOME, MyGlb.PANEL_LIST, 40, 36, 284, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PRODOTTI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PRODOTTI_NOME, MyGlb.PANEL_FORM, 2);
    ...
    PAN_PRODOTTI.SetFieldPanel(PFL_PRODOTTI_NOME, PPQRY_PRODOTTI, "A.NOME_APP", "NOME_APP", 5, 200, 0, -685);
  }
  ...
  private void PAN_PRODOTTI_InitQueries()
  {
    ...
    PAN_PRODOTTI.SetQueryDB(PPQRY_PRODOTTI, MainFrm.NotificatoreDBObject.DB, 2048);
    PAN_PRODOTTI.SetMasterTable(0, "PRODOTTI");
    SQL = new StringBuilder("select PRODOTTI_ID.NextVal from dual");
