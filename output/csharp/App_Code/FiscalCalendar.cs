...
public partial class FiscalCalendar : MyWebForm
{
  ...
  private void PAN_FISCALCALEND_InitFields()
  {
    ...
    PAN_FISCALCALEND.SetRect(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_YEAR, MyGlb.PANEL_LIST, 0, 32, 40, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FISCALCALEND.SetFieldPanel(PFL_FISCALCALEND_YEAR, PPQRY_FISCALCALEND, "A.CDN_YEAR", "CDN_YEAR", 1, 4, 0, -1709);
    PAN_FISCALCALEND.SetRect(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_PERIOD, MyGlb.PANEL_LIST, 40, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FISCALCALEND.SetFieldPanel(PFL_FISCALCALEND_PERIOD, PPQRY_FISCALCALEND, "A.PERIOD", "PERIOD", 1, 3, 0, -1709);
    PAN_FISCALCALEND.SetRect(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_DESCRIPRION, MyGlb.PANEL_LIST, 96, 32, 396, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    ...
    PAN_FISCALCALEND.SetNumRow(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_DESCRIPRION, MyGlb.PANEL_FORM, 1);
    ...
    PAN_FISCALCALEND.SetFieldPanel(PFL_FISCALCALEND_DESCRIPRION, PPQRY_FISCALCALEND, "A.DESCRIPTION", "DESCRIPTION", 5, 200, 0, -1709);
    PAN_FISCALCALEND.SetRect(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_BEGINDATE, MyGlb.PANEL_LIST, 492, 32, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    ...
    PAN_FISCALCALEND.SetFieldPanel(PFL_FISCALCALEND_BEGINDATE, PPQRY_FISCALCALEND, "A.BEGIN_DATE", "BEGIN_DATE", 6, 52, 0, -1709);
    PAN_FISCALCALEND.SetRect(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_ENDDATE, MyGlb.PANEL_LIST, 596, 32, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_MOVE);
    ...
    PAN_FISCALCALEND.SetFieldPanel(PFL_FISCALCALEND_ENDDATE, PPQRY_FISCALCALEND, "A.END_DATE", "END_DATE", 6, 52, 0, -1709);
    PAN_FISCALCALEND.SetRect(MyGlb.OBJ_FIELD, PFL_FISCALCALEND_ID, MyGlb.PANEL_LIST, 0, 32, 56, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FISCALCALEND.SetFieldPanel(PFL_FISCALCALEND_ID, PPQRY_FISCALCALEND, "A.ID", "ID", 1, 9, 0, -1709);
  }
