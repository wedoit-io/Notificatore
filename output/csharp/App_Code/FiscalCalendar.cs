...
public partial class FiscalCalendar : MyWebForm
{
  ...
  private void PAN_FISCALCALEND_InitQueries()
  {
    ...
    PAN_FISCALCALEND.SetQueryDB(PPQRY_FISCALCALEND, MainFrm.NotificatoreDBObject.DB, 2048);
    PAN_FISCALCALEND.SetMasterTable(0, "APPLE_FISCAL_CALEND");
    SQL = new StringBuilder("select APPLE_FISCAL_CALEND_ID.NextVal from dual");
