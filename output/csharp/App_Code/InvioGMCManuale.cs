...
public partial class InvioGMCManuale : MyWebForm
{
  ...
  private const int PFL_PARAMETRI_CUSTOMFIELD1 = 6;
  private const int PFL_PARAMETRI_CUSTOMFIELD2 = 7;
  ...
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI1, 8);
    ...
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI1,IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD1, "CUSTOM_FIELD1");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI1,IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD1,5,100,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI1,IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD2, "CUSTOM_FIELD2");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI1,IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD2,5,100,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI1, 0);
  }

  private static void Init_PQRY_NUOVATABELL2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NUOVATABELL2, 6);
    ...
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL2,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD1, "CUSTOM_FIELD1");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL2,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD1,5,100,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL2,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD2, "CUSTOM_FIELD2");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL2,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD2,5,100,0);
    IMDB.TblAddNew(IMDBDef1.PQRY_NUOVATABELL2, 0);
  }

  private static void Init_PQRY_NUOVATABELL2_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.PQRY_NUOVATABELL2_RS, 6);
    ...
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL2_RS,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD1, "CUSTOM_FIELD1");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL2_RS,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD1,5,100,0);
    IMDB.set_FldCode(IMDBDef1.PQRY_NUOVATABELL2_RS,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD2, "CUSTOM_FIELD2");
    IMDB.SetFldParams(IMDBDef1.PQRY_NUOVATABELL2_RS,IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD2,5,100,0);
  }
  ...
  public override void Init(WebEntryPoint w, bool flMulti, bool flSubForm)
  {
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 600-MyGlb.PAN_OFFS_X, 556-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "F3249ACB-86F1-4B3E-9670-8F71C193BA94");
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 1040, 112, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  public int EtichettaCreaspedizione ()
  {
    ...
    try
    {
      ...
      if (!(IDL.IsNull(IMDB.Value(IMDBDef1.TBL_PARAMETRI1, IMDBDef1.FLD_PARAMETRI1_ID_APPLICAZIONE, 0))))
      {
        ...
        SQL.Append("  CUSTOM_FIELD1, ");
        SQL.Append("  CUSTOM_FIELD2, ");
        SQL.Append("  REG_ID, ");
        SQL.Append("  TYPE_OS ");
        SQL.Append(") ");
        SQL.Append("values ");
        ...
        SQL.Append("  'W', ");
        SQL.Append("  GETDATE(), ");
        SQL.Append("  " + IDL.CSql(IMDB.Value(IMDBDef1.PQRY_NUOVATABELL2, IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD1, 0), IDL.FMT_CHAR, MainFrm.NotificatoreDBObject.DBO()) + ", ");
        SQL.Append("  " + IDL.CSql(IMDB.Value(IMDBDef1.PQRY_NUOVATABELL2, IMDBDef1.PQSL_NUOVATABELL2_CUSTOM_FIELD2, 0), IDL.FMT_CHAR, MainFrm.NotificatoreDBObject.DBO()) + ", ");
  ...
  private void INVIOGMCMANU_NUOVATABELL2()
  {
    ...
    Loop1: while (!IMDB.Eof(IMDBDef1.TBL_PARAMETRI1, 0))
    {
      ...
      IMDB.TblLinkField(IMDBDef1.PQRY_NUOVATABELL2_RS, 4, 0, IMDBDef1.TBL_PARAMETRI1, IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD1, 0);
      IMDB.TblLinkField(IMDBDef1.PQRY_NUOVATABELL2_RS, 5, 0, IMDBDef1.TBL_PARAMETRI1, IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD2, 0);
  ...
  private void PAN_PARAMETRI_Init()
  {
    ...
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, "350F17A1-9D70-4582-92F8-116C1D950265");
    PAN_PARAMETRI.set_Header(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, "Custom Field 1");
    PAN_PARAMETRI.set_ToolTip(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, "");
    PAN_PARAMETRI.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.VIS_NORMALFIELDS);
    PAN_PARAMETRI.SetFlags(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISOPT, -1);
    PAN_PARAMETRI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, "A2C3607D-3354-4801-BCA8-0F65B3AEC4FD");
    PAN_PARAMETRI.set_Header(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, "Custom Field 2");
    PAN_PARAMETRI.set_ToolTip(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, "");
    PAN_PARAMETRI.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.VIS_NORMALFIELDS);
    PAN_PARAMETRI.SetFlags(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISOPT, -1);
  }
  ...
  private void PAN_PARAMETRI_InitFields()
  {
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_GOOGLAPIBROW, MyGlb.PANEL_FORM, 4, 4, 528, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_GOOGLAPIBROW, PPQRY_NUOVATABELL2, "A.GOOGLE_API_ID", "GOOGLE_API_ID", 5, 100, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_RISULTATO, MyGlb.PANEL_FORM, 4, 428, 532, 104, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_RISULTATO, PPQRY_NUOVATABELL2, "A.RISUNOMEOGGE", "RISUNOMEOGGE", 9, 5000, 0, -1709);
    ...
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGIDSPEDIZI, MyGlb.PANEL_LIST, 1);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGIDSPEDIZI, MyGlb.PANEL_LIST, "Regid Spedizione");
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGIDSPEDIZI, MyGlb.PANEL_FORM, 4, 36, 528, 96, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGIDSPEDIZI, MyGlb.PANEL_FORM, 128);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_REGIDSPEDIZI, MyGlb.PANEL_FORM, 5);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_REGIDSPEDIZI, PPQRY_NUOVATABELL2, "A.REG_ID", "REG_ID", 5, 200, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 4, 140, 528, 156, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 128);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_MESSAGSPEDIZ, MyGlb.PANEL_FORM, 9);
    ...
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_MESSAGSPEDIZ, PPQRY_NUOVATABELL2, "A.DES_MESSAGGIO", "DES_MESSAGGIO", 9, 1000, 0, -1709);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHETINVIA, MyGlb.PANEL_FORM, 424, 376, 108, 36, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHETINVIA, MyGlb.PANEL_FORM, 0);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHETINVIA, MyGlb.PANEL_FORM, 2);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICCREASPED, MyGlb.PANEL_FORM, 300, 376, 116, 36, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_LIST, 0, 36, 304, 48, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_LIST, 164);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_LIST, 2);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_LIST, "Custom Field 1");
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_FORM, 4, 300, 528, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_FORM, 128);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_FORM, 1);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD1, MyGlb.PANEL_FORM, "Custom Field 1");
    PAN_PARAMETRI.SetFieldPage(PFL_PARAMETRI_CUSTOMFIELD1, -1, -1);
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_CUSTOMFIELD1, PPQRY_NUOVATABELL2, "A.CUSTOM_FIELD1", "CUSTOM_FIELD1", 5, 100, 0, -1709);
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_LIST, 0, 36, 304, 48, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_LIST, 164);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_LIST, 2);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_LIST, "Custom Field 2");
    PAN_PARAMETRI.SetRect(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_FORM, 4, 332, 528, 28, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAMETRI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_FORM, 128);
    PAN_PARAMETRI.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_FORM, 1);
    PAN_PARAMETRI.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAMETRI_CUSTOMFIELD2, MyGlb.PANEL_FORM, "Custom Field 2");
    PAN_PARAMETRI.SetFieldPage(PFL_PARAMETRI_CUSTOMFIELD2, -1, -1);
    PAN_PARAMETRI.SetFieldPanel(PFL_PARAMETRI_CUSTOMFIELD2, PPQRY_NUOVATABELL2, "A.CUSTOM_FIELD2", "CUSTOM_FIELD2", 5, 100, 0, -1709);
  }
  ...
  private void PAN_PARAMETRI_InitQueries()
  {
    ...
    PAN_PARAMETRI.SetFieldPrimaryIndex(PFL_PARAMETRI_CUSTOMFIELD1, IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD1);
    PAN_PARAMETRI.SetFieldPrimaryIndex(PFL_PARAMETRI_CUSTOMFIELD2, IMDBDef1.FLD_PARAMETRI1_CUSTOM_FIELD2);
